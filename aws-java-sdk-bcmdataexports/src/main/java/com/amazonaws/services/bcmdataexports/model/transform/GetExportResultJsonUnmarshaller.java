        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Export", targetDepth)) {
                    context.nextToken();
                    getExportResult.setExport(ExportJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("ExportStatus", targetDepth)) {
                    context.nextToken();
                    getExportResult.setExportStatus(ExportStatusJsonUnmarshaller.getInstance().unmarshall(context));
                }
