        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Description", targetDepth)) {
                    context.nextToken();
                    getTableResult.setDescription(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Schema", targetDepth)) {
                    context.nextToken();
                    getTableResult.setSchema(new ListUnmarshaller<Column>(ColumnJsonUnmarshaller.getInstance())
                ...
                if (context.testExpression("TableProperties", targetDepth)) {
                    context.nextToken();
                    getTableResult.setTableProperties(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
