...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/bcm-data-exports-2023-11-26/ListExecutions" target="_top">AWS
 *      API Documentation</a>
 */
...
public class ListExecutionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ExecutionReference> executions;
    /**
     * <p>
    ...
    public java.util.List<ExecutionReference> getExecutions() {
        return executions;
    }
    ...
    public void setExecutions(java.util.Collection<ExecutionReference> executions) {
        if (executions == null) {
            this.executions = null;
            return;
        }

        this.executions = new java.util.ArrayList<ExecutionReference>(executions);
    }
    ...
    public ListExecutionsResult withExecutions(ExecutionReference... executions) {
        if (this.executions == null) {
            setExecutions(new java.util.ArrayList<ExecutionReference>(executions.length));
        }
        for (ExecutionReference ele : executions) {
    ...
    public ListExecutionsResult withExecutions(java.util.Collection<ExecutionReference> executions) {
