...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.bcmdataexports.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.bcmdataexports.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bcmdataexports.model.ThrottlingException throttlingException = new com.amazonaws.services.bcmdataexports.model.ThrottlingException(
                null);
