...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.bcmdataexports.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.bcmdataexports.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.bcmdataexports.model.ValidationException validationException = new com.amazonaws.services.bcmdataexports.model.ValidationException(
                null);
