...
public class ListExtensionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<ExtensionSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The list of available extensions. The list includes Amazon Web Services authored and user-created
     *         extensions.
     */

    public java.util.List<ExtensionSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<ExtensionSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<ExtensionSummary>(items);
    }
    ...
    public ListExtensionsResult withItems(ExtensionSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<ExtensionSummary>(items.length));
        }
        for (ExtensionSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListExtensionsResult withItems(java.util.Collection<ExtensionSummary> items) {
        setItems(items);
        return this;
    }
