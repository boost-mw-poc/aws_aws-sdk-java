...
public class BatchGetVpcEndpointRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A list of VPC endpoint identifiers.
     */
    ...
    public BatchGetVpcEndpointRequest withIds(java.util.Collection<String> ids) {
        setIds(ids);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchGetVpcEndpointRequest == false)
            return false;
        BatchGetVpcEndpointRequest other = (BatchGetVpcEndpointRequest) obj;
    ...
    @Override
    public BatchGetVpcEndpointRequest clone() {
        return (BatchGetVpcEndpointRequest) super.clone();
    }
