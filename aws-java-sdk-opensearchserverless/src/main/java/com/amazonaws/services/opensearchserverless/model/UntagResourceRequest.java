...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param resourceArn
     *        The Amazon Resource Name (ARN) of the resource to remove tags from. The resource must be active (not in
     *        the <code>DELETING</code> state), and must be owned by the account ID included in the request.
     */
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the resource to remove tags from. The resource must be active (not in
     *         the <code>DELETING</code> state), and must be owned by the account ID included in the request.
     */
     ...
     * </p>
     * 
     * @return The tag or set of tags to remove from the resource. All tag keys in the request must be unique.
     */
