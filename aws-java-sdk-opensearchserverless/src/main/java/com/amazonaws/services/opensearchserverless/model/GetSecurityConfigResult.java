...
public class GetSecurityConfigResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Details of the requested security configuration.
     */
    ...
    public GetSecurityConfigResult withSecurityConfigDetail(SecurityConfigDetail securityConfigDetail) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSecurityConfigResult == false)
            return false;
        GetSecurityConfigResult other = (GetSecurityConfigResult) obj;
    ...
    @Override
    public GetSecurityConfigResult clone() {
        try {
            return (GetSecurityConfigResult) super.clone();
