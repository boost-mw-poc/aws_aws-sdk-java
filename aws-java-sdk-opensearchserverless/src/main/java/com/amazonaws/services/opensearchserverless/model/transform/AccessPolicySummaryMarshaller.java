...
public class AccessPolicySummaryMarshaller {
    ...
    public void marshall(AccessPolicySummary accessPolicySummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accessPolicySummary.getCreatedDate(), CREATEDDATE_BINDING);
            protocolMarshaller.marshall(accessPolicySummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(accessPolicySummary.getLastModifiedDate(), LASTMODIFIEDDATE_BINDING);
            protocolMarshaller.marshall(accessPolicySummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(accessPolicySummary.getPolicyVersion(), POLICYVERSION_BINDING);
            protocolMarshaller.marshall(accessPolicySummary.getType(), TYPE_BINDING);
        } catch (Exception e) {
