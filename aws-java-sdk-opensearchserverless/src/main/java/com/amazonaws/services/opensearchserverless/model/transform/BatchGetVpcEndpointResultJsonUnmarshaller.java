...
/**
 * BatchGetVpcEndpointResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchGetVpcEndpointResultJsonUnmarshaller implements Unmarshaller<BatchGetVpcEndpointResult, JsonUnmarshallerContext> {

    public BatchGetVpcEndpointResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        BatchGetVpcEndpointResult batchGetVpcEndpointResult = new BatchGetVpcEndpointResult();
    ...
    private static BatchGetVpcEndpointResultJsonUnmarshaller instance;

    public static BatchGetVpcEndpointResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new BatchGetVpcEndpointResultJsonUnmarshaller();
        return instance;
    }
}
