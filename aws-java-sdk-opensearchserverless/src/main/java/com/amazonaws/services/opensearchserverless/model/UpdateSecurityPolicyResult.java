...
public class UpdateSecurityPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSecurityPolicyResult withSecurityPolicyDetail(SecurityPolicyDetail securityPolicyDetail) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSecurityPolicyResult == false)
            return false;
        UpdateSecurityPolicyResult other = (UpdateSecurityPolicyResult) obj;
    ...
    @Override
    public UpdateSecurityPolicyResult clone() {
        try {
            return (UpdateSecurityPolicyResult) super.clone();
