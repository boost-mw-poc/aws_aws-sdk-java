...
public class DeleteVpcEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteVpcEndpointDetail getDeleteVpcEndpointDetail() {
    ...
    public DeleteVpcEndpointResult withDeleteVpcEndpointDetail(DeleteVpcEndpointDetail deleteVpcEndpointDetail) {
        setDeleteVpcEndpointDetail(deleteVpcEndpointDetail);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("{");
        if (getDeleteVpcEndpointDetail() != null)
            sb.append("DeleteVpcEndpointDetail: ").append(getDeleteVpcEndpointDetail());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getDeleteVpcEndpointDetail() == null ^ this.getDeleteVpcEndpointDetail() == null)
            return false;
        if (other.getDeleteVpcEndpointDetail() != null && other.getDeleteVpcEndpointDetail().equals(this.getDeleteVpcEndpointDetail()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getDeleteVpcEndpointDetail() == null) ? 0 : getDeleteVpcEndpointDetail().hashCode());
        return hashCode;
    }
