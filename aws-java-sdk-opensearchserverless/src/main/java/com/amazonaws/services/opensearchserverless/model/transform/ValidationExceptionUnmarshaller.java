...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.opensearchserverless.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.opensearchserverless.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.opensearchserverless.model.ValidationException validationException = new com.amazonaws.services.opensearchserverless.model.ValidationException(
                null);
