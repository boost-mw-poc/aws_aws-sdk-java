 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/opensearchserverless-2021-11-01/SecurityPolicySummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SecurityPolicySummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public SecurityPolicySummary withType(String type) {
        setType(type);
        return this;
    }
    ...
    public SecurityPolicySummary withType(SecurityPolicyType type) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecurityPolicySummary == false)
            return false;
        SecurityPolicySummary other = (SecurityPolicySummary) obj;
    ...
    @Override
    public SecurityPolicySummary clone() {
        try {
            return (SecurityPolicySummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearchserverless.model.transform.SecurityPolicySummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
