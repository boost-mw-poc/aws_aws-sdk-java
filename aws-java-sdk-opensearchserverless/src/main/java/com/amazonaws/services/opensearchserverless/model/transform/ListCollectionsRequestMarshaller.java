...
public class ListCollectionsRequestMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> COLLECTIONFILTERS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("collectionFilters").build();
    ...
    public void marshall(ListCollectionsRequest listCollectionsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listCollectionsRequest.getCollectionFilters(), COLLECTIONFILTERS_BINDING);
