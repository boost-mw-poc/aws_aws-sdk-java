...
public class GetAccessPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Details about the requested access policy.
     */
    ...
    public GetAccessPolicyResult withAccessPolicyDetail(AccessPolicyDetail accessPolicyDetail) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAccessPolicyResult == false)
            return false;
        GetAccessPolicyResult other = (GetAccessPolicyResult) obj;
    ...
    @Override
    public GetAccessPolicyResult clone() {
        try {
            return (GetAccessPolicyResult) super.clone();
