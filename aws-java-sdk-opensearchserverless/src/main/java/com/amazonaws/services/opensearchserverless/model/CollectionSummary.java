 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/opensearchserverless-2021-11-01/CollectionSummary"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CollectionSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public CollectionSummary withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public CollectionSummary withStatus(CollectionStatus status) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearchserverless.model.transform.CollectionSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
