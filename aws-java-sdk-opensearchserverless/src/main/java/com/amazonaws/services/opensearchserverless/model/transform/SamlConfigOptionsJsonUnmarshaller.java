...
/**
 * SamlConfigOptions JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SamlConfigOptionsJsonUnmarshaller implements Unmarshaller<SamlConfigOptions, JsonUnmarshallerContext> {

    public SamlConfigOptions unmarshall(JsonUnmarshallerContext context) throws Exception {
        SamlConfigOptions samlConfigOptions = new SamlConfigOptions();
    ...
    private static SamlConfigOptionsJsonUnmarshaller instance;

    public static SamlConfigOptionsJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new SamlConfigOptionsJsonUnmarshaller();
        return instance;
    }
}
