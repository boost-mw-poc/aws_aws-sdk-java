...
public class CreateAccessPolicyRequestMarshaller {
    ...
    public void marshall(CreateAccessPolicyRequest createAccessPolicyRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(createAccessPolicyRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createAccessPolicyRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createAccessPolicyRequest.getPolicy(), POLICY_BINDING);
            protocolMarshaller.marshall(createAccessPolicyRequest.getType(), TYPE_BINDING);
        } catch (Exception e) {
