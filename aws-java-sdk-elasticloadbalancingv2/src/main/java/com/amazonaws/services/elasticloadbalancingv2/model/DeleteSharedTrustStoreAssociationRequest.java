...
public class DeleteSharedTrustStoreAssociationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteSharedTrustStoreAssociationRequest withTrustStoreArn(String trustStoreArn) {
    ...
    public DeleteSharedTrustStoreAssociationRequest withResourceArn(String resourceArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteSharedTrustStoreAssociationRequest == false)
            return false;
        DeleteSharedTrustStoreAssociationRequest other = (DeleteSharedTrustStoreAssociationRequest) obj;
    ...
    @Override
    public DeleteSharedTrustStoreAssociationRequest clone() {
