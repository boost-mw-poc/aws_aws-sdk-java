...
public class GetTrustStoreCaCertificatesBundleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetTrustStoreCaCertificatesBundleRequest withTrustStoreArn(String trustStoreArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTrustStoreCaCertificatesBundleRequest == false)
            return false;
        GetTrustStoreCaCertificatesBundleRequest other = (GetTrustStoreCaCertificatesBundleRequest) obj;
    ...
    @Override
    public GetTrustStoreCaCertificatesBundleRequest clone() {
