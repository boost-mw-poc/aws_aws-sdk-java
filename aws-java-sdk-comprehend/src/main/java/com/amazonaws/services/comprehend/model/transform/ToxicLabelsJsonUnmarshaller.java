...
/**
 * ToxicLabels JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ToxicLabelsJsonUnmarshaller implements Unmarshaller<ToxicLabels, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Labels", targetDepth)) {
                    context.nextToken();
                    toxicLabels.setLabels(new ListUnmarshaller<ToxicContent>(ToxicContentJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("Toxicity", targetDepth)) {
                    context.nextToken();
                    toxicLabels.setToxicity(context.getUnmarshaller(Float.class).unmarshall(context));
                }
