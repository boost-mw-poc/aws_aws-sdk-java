...
/**
 * DeleteEvaluationFormResult JSON Unmarshaller
 */
...
public class DeleteEvaluationFormResultJsonUnmarshaller implements Unmarshaller<DeleteEvaluationFormResult, JsonUnmarshallerContext> {
    ...
    public DeleteEvaluationFormResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEvaluationFormResult deleteEvaluationFormResult = new DeleteEvaluationFormResult();

        return deleteEvaluationFormResult;
    }
