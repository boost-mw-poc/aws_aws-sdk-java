 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/EvaluationAnswerInput" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EvaluationAnswerInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public EvaluationAnswerInput clone() {
        try {
            return (EvaluationAnswerInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.EvaluationAnswerInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
