 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ContactSearchSummaryAgentInfo"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContactSearchSummaryAgentInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public ContactSearchSummaryAgentInfo withConnectedToAgentTimestamp(java.util.Date connectedToAgentTimestamp) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ContactSearchSummaryAgentInfo == false)
            return false;
        ContactSearchSummaryAgentInfo other = (ContactSearchSummaryAgentInfo) obj;
    ...
    @Override
    public ContactSearchSummaryAgentInfo clone() {
        try {
            return (ContactSearchSummaryAgentInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.ContactSearchSummaryAgentInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
