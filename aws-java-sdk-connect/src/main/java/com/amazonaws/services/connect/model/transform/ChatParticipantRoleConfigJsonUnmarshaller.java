...
/**
 * ChatParticipantRoleConfig JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ChatParticipantRoleConfigJsonUnmarshaller implements Unmarshaller<ChatParticipantRoleConfig, JsonUnmarshallerContext> {
    ...
    public ChatParticipantRoleConfig unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ParticipantTimerConfigList", targetDepth)) {
                    context.nextToken();
                    chatParticipantRoleConfig.setParticipantTimerConfigList(new ListUnmarshaller<ParticipantTimerConfiguration>(
