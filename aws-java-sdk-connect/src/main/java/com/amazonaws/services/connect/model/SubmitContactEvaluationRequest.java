...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/SubmitContactEvaluation" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SubmitContactEvaluationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public SubmitContactEvaluationRequest withAnswers(java.util.Map<String, EvaluationAnswerInput> answers) {
        setAnswers(answers);
        return this;
    }
     ...
     *
     * @see SubmitContactEvaluationRequest#withAnswers
     ...
     *
     * @see SubmitContactEvaluationRequest#withNotes
     * @returns a reference to this object so that method calls can be chained together.
     */
    ...
    @Override
    public SubmitContactEvaluationRequest clone() {
        return (SubmitContactEvaluationRequest) super.clone();
    }
