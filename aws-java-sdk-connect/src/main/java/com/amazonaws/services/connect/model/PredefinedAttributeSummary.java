 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/PredefinedAttributeSummary" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PredefinedAttributeSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    public PredefinedAttributeSummary withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PredefinedAttributeSummary == false)
            return false;
        PredefinedAttributeSummary other = (PredefinedAttributeSummary) obj;
    ...
    public PredefinedAttributeSummary clone() {
        try {
            return (PredefinedAttributeSummary) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.PredefinedAttributeSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
