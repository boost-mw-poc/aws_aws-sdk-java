        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Users", targetDepth)) {
                    context.nextToken();
                    searchUsersResult.setUsers(new ListUnmarshaller<UserSearchSummary>(UserSearchSummaryJsonUnmarshaller.getInstance())
                ...
                if (context.testExpression("ApproximateTotalCount", targetDepth)) {
                    context.nextToken();
                    searchUsersResult.setApproximateTotalCount(context.getUnmarshaller(Long.class).unmarshall(context));
                }
