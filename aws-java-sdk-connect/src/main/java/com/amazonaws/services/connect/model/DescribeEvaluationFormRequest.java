...
public class DescribeEvaluationFormRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DescribeEvaluationFormRequest clone() {
        return (DescribeEvaluationFormRequest) super.clone();
    }
