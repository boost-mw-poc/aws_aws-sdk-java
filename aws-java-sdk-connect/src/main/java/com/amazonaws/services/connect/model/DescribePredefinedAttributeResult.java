...
public class DescribePredefinedAttributeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Information about the predefined attribute.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getPredefinedAttribute() == null ^ this.getPredefinedAttribute() == null)
            return false;
        if (other.getPredefinedAttribute() != null && other.getPredefinedAttribute().equals(this.getPredefinedAttribute()) == false)
            return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getPredefinedAttribute() == null) ? 0 : getPredefinedAttribute().hashCode());
        return hashCode;
    }
