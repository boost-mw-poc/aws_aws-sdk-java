 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/connect-2017-08-08/ContactSearchSummaryQueueInfo"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ContactSearchSummaryQueueInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public ContactSearchSummaryQueueInfo clone() {
        try {
            return (ContactSearchSummaryQueueInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.ContactSearchSummaryQueueInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
