...
/**
 * AssociateUserProficienciesResult JSON Unmarshaller
 */
...
public class AssociateUserProficienciesResultJsonUnmarshaller implements Unmarshaller<AssociateUserProficienciesResult, JsonUnmarshallerContext> {
    ...
    public AssociateUserProficienciesResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        AssociateUserProficienciesResult associateUserProficienciesResult = new AssociateUserProficienciesResult();

        return associateUserProficienciesResult;
    }
