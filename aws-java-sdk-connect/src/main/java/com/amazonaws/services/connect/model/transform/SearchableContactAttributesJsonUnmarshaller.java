...
/**
 * SearchableContactAttributes JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SearchableContactAttributesJsonUnmarshaller implements Unmarshaller<SearchableContactAttributes, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Criteria", targetDepth)) {
                    context.nextToken();
                    searchableContactAttributes.setCriteria(new ListUnmarshaller<SearchableContactAttributesCriteria>(
                ...
                if (context.testExpression("MatchType", targetDepth)) {
                    context.nextToken();
                    searchableContactAttributes.setMatchType(context.getUnmarshaller(String.class).unmarshall(context));
                }
