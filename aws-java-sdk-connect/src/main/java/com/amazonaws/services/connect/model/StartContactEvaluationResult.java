...
public class StartContactEvaluationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartContactEvaluationResult clone() {
        try {
            return (StartContactEvaluationResult) super.clone();
