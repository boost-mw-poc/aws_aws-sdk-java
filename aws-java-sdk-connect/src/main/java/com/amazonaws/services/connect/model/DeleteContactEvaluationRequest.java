...
public class DeleteContactEvaluationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public DeleteContactEvaluationRequest clone() {
        return (DeleteContactEvaluationRequest) super.clone();
    }
