...
/**
 * DeletePredefinedAttributeResult JSON Unmarshaller
 */
...
public class DeletePredefinedAttributeResultJsonUnmarshaller implements Unmarshaller<DeletePredefinedAttributeResult, JsonUnmarshallerContext> {
    ...
    public DeletePredefinedAttributeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeletePredefinedAttributeResult deletePredefinedAttributeResult = new DeletePredefinedAttributeResult();

        return deletePredefinedAttributeResult;
    }
