...
public class SubmitContactEvaluationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SubmitContactEvaluationResult == false)
            return false;
        SubmitContactEvaluationResult other = (SubmitContactEvaluationResult) obj;
    ...
    public SubmitContactEvaluationResult clone() {
        try {
            return (SubmitContactEvaluationResult) super.clone();
