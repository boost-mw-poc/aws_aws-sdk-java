...
/**
 * CreatePredefinedAttributeResult JSON Unmarshaller
 */
...
public class CreatePredefinedAttributeResultJsonUnmarshaller implements Unmarshaller<CreatePredefinedAttributeResult, JsonUnmarshallerContext> {
    ...
    public CreatePredefinedAttributeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreatePredefinedAttributeResult createPredefinedAttributeResult = new CreatePredefinedAttributeResult();

        return createPredefinedAttributeResult;
    }
