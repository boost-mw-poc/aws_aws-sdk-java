...
public class ListEvaluationFormVersionsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListEvaluationFormVersionsRequest withInstanceId(String instanceId) {
    ...
    public ListEvaluationFormVersionsRequest withEvaluationFormId(String evaluationFormId) {
    ...
    public ListEvaluationFormVersionsRequest withMaxResults(Integer maxResults) {
    ...
    public ListEvaluationFormVersionsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEvaluationFormVersionsRequest == false)
            return false;
        ListEvaluationFormVersionsRequest other = (ListEvaluationFormVersionsRequest) obj;
    ...
    @Override
    public ListEvaluationFormVersionsRequest clone() {
        return (ListEvaluationFormVersionsRequest) super.clone();
    }
