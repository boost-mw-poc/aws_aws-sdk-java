...
public class SearchUsersRequestMarshaller {
    ...
    public void marshall(SearchUsersRequest searchUsersRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchUsersRequest.getInstanceId(), INSTANCEID_BINDING);
            ...
            protocolMarshaller.marshall(searchUsersRequest.getSearchFilter(), SEARCHFILTER_BINDING);
            protocolMarshaller.marshall(searchUsersRequest.getSearchCriteria(), SEARCHCRITERIA_BINDING);
        } catch (Exception e) {
