...
public class ActivateEvaluationFormRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    @Override
    public ActivateEvaluationFormRequest clone() {
        return (ActivateEvaluationFormRequest) super.clone();
    }
