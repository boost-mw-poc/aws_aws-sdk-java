...
/**
 * UserSearchSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class UserSearchSummaryMarshaller {
    ...
    private static final UserSearchSummaryMarshaller instance = new UserSearchSummaryMarshaller();

    public static UserSearchSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UserSearchSummary userSearchSummary, ProtocolMarshaller protocolMarshaller) {

        if (userSearchSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(userSearchSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getDirectoryUserId(), DIRECTORYUSERID_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getHierarchyGroupId(), HIERARCHYGROUPID_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getIdentityInfo(), IDENTITYINFO_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getPhoneConfig(), PHONECONFIG_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getRoutingProfileId(), ROUTINGPROFILEID_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getSecurityProfileIds(), SECURITYPROFILEIDS_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(userSearchSummary.getUsername(), USERNAME_BINDING);
        } catch (Exception e) {
