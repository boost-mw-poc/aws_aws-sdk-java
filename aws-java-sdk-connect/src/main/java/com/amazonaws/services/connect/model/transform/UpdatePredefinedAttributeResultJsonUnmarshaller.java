...
/**
 * UpdatePredefinedAttributeResult JSON Unmarshaller
 */
...
public class UpdatePredefinedAttributeResultJsonUnmarshaller implements Unmarshaller<UpdatePredefinedAttributeResult, JsonUnmarshallerContext> {
    ...
    public UpdatePredefinedAttributeResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdatePredefinedAttributeResult updatePredefinedAttributeResult = new UpdatePredefinedAttributeResult();

        return updatePredefinedAttributeResult;
    }
