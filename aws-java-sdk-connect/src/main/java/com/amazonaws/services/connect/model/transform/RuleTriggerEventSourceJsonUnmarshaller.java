...
/**
 * RuleTriggerEventSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RuleTriggerEventSourceJsonUnmarshaller implements Unmarshaller<RuleTriggerEventSource, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("EventSourceName", targetDepth)) {
                    context.nextToken();
                    ruleTriggerEventSource.setEventSourceName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("IntegrationAssociationId", targetDepth)) {
                    context.nextToken();
                    ruleTriggerEventSource.setIntegrationAssociationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
