...
/**
 * UserIdentityInfoLite JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UserIdentityInfoLiteJsonUnmarshaller implements Unmarshaller<UserIdentityInfoLite, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("FirstName", targetDepth)) {
                    context.nextToken();
                    userIdentityInfoLite.setFirstName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("LastName", targetDepth)) {
                    context.nextToken();
                    userIdentityInfoLite.setLastName(context.getUnmarshaller(String.class).unmarshall(context));
                }
