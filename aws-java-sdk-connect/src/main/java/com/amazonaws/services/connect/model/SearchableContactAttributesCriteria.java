...
public class SearchableContactAttributesCriteria implements Serializable, Cloneable, StructuredPojo {
    ...
    @Override
    public SearchableContactAttributesCriteria clone() {
        try {
            return (SearchableContactAttributesCriteria) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.connect.model.transform.SearchableContactAttributesCriteriaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
