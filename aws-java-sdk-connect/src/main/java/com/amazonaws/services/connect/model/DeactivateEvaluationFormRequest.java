...
public class DeactivateEvaluationFormRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * A version of the evaluation form. If the version property is not provided, the latest version of the evaluation
     * form is deactivated.
     * </p>
     */
    ...
    public DeactivateEvaluationFormRequest withInstanceId(String instanceId) {
    ...
    public DeactivateEvaluationFormRequest withEvaluationFormId(String evaluationFormId) {
     ...
     * </p>
     * 
     * @return A version of the evaluation form. If the version property is not provided, the latest version of the
     *         evaluation form is deactivated.
     */
    ...
    public DeactivateEvaluationFormRequest withEvaluationFormVersion(Integer evaluationFormVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeactivateEvaluationFormRequest == false)
            return false;
        DeactivateEvaluationFormRequest other = (DeactivateEvaluationFormRequest) obj;
    ...
    @Override
    public DeactivateEvaluationFormRequest clone() {
