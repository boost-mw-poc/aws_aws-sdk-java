...
/**
 * XksProxyAuthenticationCredentialTypeMarshaller
 */
...
public class XksProxyAuthenticationCredentialTypeMarshaller {
    ...
    private static final MarshallingInfo<String> RAWSECRETACCESSKEY_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("RawSecretAccessKey").build();
