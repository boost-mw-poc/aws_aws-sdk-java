...
public class ListFindingsV2Request extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListFindingsV2Request withFilter(java.util.Map<String, Criterion> filter) {
        setFilter(filter);
        return this;
    }
     ...
     *
     * @see ListFindingsV2Request#withFilter
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ListFindingsV2Request addFilterEntry(String key, Criterion value) {
        if (null == this.filter) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListFindingsV2Request == false)
            return false;
        ListFindingsV2Request other = (ListFindingsV2Request) obj;
    ...
    public ListFindingsV2Request clone() {
        return (ListFindingsV2Request) super.clone();
    }
