 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/accessanalyzer-2019-11-01/UnusedIamRoleDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UnusedIamRoleDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public UnusedIamRoleDetails withLastAccessed(java.util.Date lastAccessed) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UnusedIamRoleDetails == false)
            return false;
    ...
    @Override
    public UnusedIamRoleDetails clone() {
        try {
            return (UnusedIamRoleDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.accessanalyzer.model.transform.UnusedIamRoleDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
