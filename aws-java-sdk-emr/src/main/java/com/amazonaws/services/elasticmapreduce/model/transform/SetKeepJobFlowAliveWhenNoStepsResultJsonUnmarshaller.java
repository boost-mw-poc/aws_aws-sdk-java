...
/**
 * SetKeepJobFlowAliveWhenNoStepsResult JSON Unmarshaller
 */
...
public class SetKeepJobFlowAliveWhenNoStepsResultJsonUnmarshaller implements Unmarshaller<SetKeepJobFlowAliveWhenNoStepsResult, JsonUnmarshallerContext> {
    ...
    public SetKeepJobFlowAliveWhenNoStepsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        SetKeepJobFlowAliveWhenNoStepsResult setKeepJobFlowAliveWhenNoStepsResult = new SetKeepJobFlowAliveWhenNoStepsResult();

        return setKeepJobFlowAliveWhenNoStepsResult;
    }
