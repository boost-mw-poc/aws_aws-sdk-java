...
public class AIMLOptionsInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public NaturalLanguageQueryGenerationOptionsInput getNaturalLanguageQueryGenerationOptions() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AIMLOptionsInput == false)
            return false;
    ...
    public AIMLOptionsInput clone() {
        try {
            return (AIMLOptionsInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.opensearch.model.transform.AIMLOptionsInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
