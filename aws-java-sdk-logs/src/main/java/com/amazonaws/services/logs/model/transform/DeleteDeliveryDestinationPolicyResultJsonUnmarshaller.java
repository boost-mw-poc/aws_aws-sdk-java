...
/**
 * DeleteDeliveryDestinationPolicyResult JSON Unmarshaller
 */
...
public class DeleteDeliveryDestinationPolicyResultJsonUnmarshaller implements Unmarshaller<DeleteDeliveryDestinationPolicyResult, JsonUnmarshallerContext> {
    ...
    public DeleteDeliveryDestinationPolicyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDeliveryDestinationPolicyResult deleteDeliveryDestinationPolicyResult = new DeleteDeliveryDestinationPolicyResult();

        return deleteDeliveryDestinationPolicyResult;
    }
