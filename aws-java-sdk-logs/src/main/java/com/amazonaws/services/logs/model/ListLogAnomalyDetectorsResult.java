...
public class ListLogAnomalyDetectorsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return An array of structures, where each structure in the array contains information about one anomaly
     *         detector.
     */
    ...
    public ListLogAnomalyDetectorsResult withAnomalyDetectors(AnomalyDetector... anomalyDetectors) {
    ...
    public ListLogAnomalyDetectorsResult withAnomalyDetectors(java.util.Collection<AnomalyDetector> anomalyDetectors) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListLogAnomalyDetectorsResult == false)
            return false;
        ListLogAnomalyDetectorsResult other = (ListLogAnomalyDetectorsResult) obj;
    ...
    public ListLogAnomalyDetectorsResult clone() {
        try {
            return (ListLogAnomalyDetectorsResult) super.clone();
