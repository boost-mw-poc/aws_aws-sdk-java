...
/**
 * UpdateAnomalyResult JSON Unmarshaller
 */
...
public class UpdateAnomalyResultJsonUnmarshaller implements Unmarshaller<UpdateAnomalyResult, JsonUnmarshallerContext> {
    ...
    public UpdateAnomalyResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateAnomalyResult updateAnomalyResult = new UpdateAnomalyResult();

        return updateAnomalyResult;
    }
