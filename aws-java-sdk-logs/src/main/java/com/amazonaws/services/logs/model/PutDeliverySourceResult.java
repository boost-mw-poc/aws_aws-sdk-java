...
public class PutDeliverySourceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return A structure containing information about the delivery source that was just created or updated.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutDeliverySourceResult == false)
            return false;
        PutDeliverySourceResult other = (PutDeliverySourceResult) obj;
    ...
    @Override
    public PutDeliverySourceResult clone() {
        try {
            return (PutDeliverySourceResult) super.clone();
