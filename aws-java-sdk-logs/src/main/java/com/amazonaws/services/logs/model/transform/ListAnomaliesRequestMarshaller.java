...
public class ListAnomaliesRequestMarshaller {
    ...
    private static final MarshallingInfo<String> SUPPRESSIONSTATE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("suppressionState").build();
