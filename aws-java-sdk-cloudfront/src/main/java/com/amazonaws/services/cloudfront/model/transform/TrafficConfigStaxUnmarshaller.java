...
/**
 * TrafficConfig StAX Unmarshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrafficConfigStaxUnmarshaller implements Unmarshaller<TrafficConfig, StaxUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("Type", targetDepth)) {
                    trafficConfig.setType(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
