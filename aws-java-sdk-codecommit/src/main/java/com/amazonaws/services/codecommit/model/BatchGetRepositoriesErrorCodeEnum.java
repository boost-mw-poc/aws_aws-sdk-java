...
public enum BatchGetRepositoriesErrorCodeEnum {
    ...
    private BatchGetRepositoriesErrorCodeEnum(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return BatchGetRepositoriesErrorCodeEnum corresponding to the value
     *
    ...
    public static BatchGetRepositoriesErrorCodeEnum fromValue(String value) {
        ...
        for (BatchGetRepositoriesErrorCodeEnum enumEntry : BatchGetRepositoriesErrorCodeEnum.values()) {
