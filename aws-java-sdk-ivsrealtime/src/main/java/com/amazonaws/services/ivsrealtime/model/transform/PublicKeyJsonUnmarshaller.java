        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("arn", targetDepth)) {
                    context.nextToken();
                    publicKey.setArn(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    publicKey.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("publicKeyMaterial", targetDepth)) {
                    context.nextToken();
                    publicKey.setPublicKeyMaterial(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("tags", targetDepth)) {
                    context.nextToken();
                    publicKey.setTags(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
