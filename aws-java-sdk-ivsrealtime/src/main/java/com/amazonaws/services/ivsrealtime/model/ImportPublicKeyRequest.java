...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/ImportPublicKey" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ImportPublicKeyRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The content of the public key to be imported.
     */
     ...
     * </p>
     * 
     * @return Name of the public key to be imported.
     */
    ...
    public ImportPublicKeyRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see ImportPublicKeyRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public ImportPublicKeyRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ImportPublicKeyRequest == false)
            return false;
        ImportPublicKeyRequest other = (ImportPublicKeyRequest) obj;
    ...
    public ImportPublicKeyRequest clone() {
        return (ImportPublicKeyRequest) super.clone();
    }
