...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ivs-realtime-2020-07-14/ListPublicKeys" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ListPublicKeysResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<PublicKeySummary> publicKeys;
    /**
     * <p>
    ...
    public java.util.List<PublicKeySummary> getPublicKeys() {
        return publicKeys;
    }
    ...
    public void setPublicKeys(java.util.Collection<PublicKeySummary> publicKeys) {
        if (publicKeys == null) {
            this.publicKeys = null;
            return;
        }

        this.publicKeys = new java.util.ArrayList<PublicKeySummary>(publicKeys);
    }
    ...
    public ListPublicKeysResult withPublicKeys(PublicKeySummary... publicKeys) {
        if (this.publicKeys == null) {
            setPublicKeys(new java.util.ArrayList<PublicKeySummary>(publicKeys.length));
        }
        for (PublicKeySummary ele : publicKeys) {
    ...
    public ListPublicKeysResult withPublicKeys(java.util.Collection<PublicKeySummary> publicKeys) {
     ...
     * 
     * @param nextToken
     *        If there are more public keys than <code>maxResults</code>, use <code>nextToken</code> in the request to
     *        get the next set.
     */
