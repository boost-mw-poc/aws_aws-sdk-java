...
public class PublicKeyMarshaller {
    ...
    public void marshall(PublicKey publicKey, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(publicKey.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(publicKey.getName(), NAME_BINDING);
            protocolMarshaller.marshall(publicKey.getPublicKeyMaterial(), PUBLICKEYMATERIAL_BINDING);
            protocolMarshaller.marshall(publicKey.getFingerprint(), FINGERPRINT_BINDING);
            protocolMarshaller.marshall(publicKey.getTags(), TAGS_BINDING);
        } catch (Exception e) {
