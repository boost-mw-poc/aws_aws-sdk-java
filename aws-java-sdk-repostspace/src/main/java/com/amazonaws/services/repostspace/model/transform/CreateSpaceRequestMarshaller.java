...
public class CreateSpaceRequestMarshaller {
    ...
    public void marshall(CreateSpaceRequest createSpaceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createSpaceRequest.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(createSpaceRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createSpaceRequest.getRoleArn(), ROLEARN_BINDING);
            protocolMarshaller.marshall(createSpaceRequest.getSubdomain(), SUBDOMAIN_BINDING);
            protocolMarshaller.marshall(createSpaceRequest.getTags(), TAGS_BINDING);
            protocolMarshaller.marshall(createSpaceRequest.getTier(), TIER_BINDING);
            protocolMarshaller.marshall(createSpaceRequest.getUserKMSKey(), USERKMSKEY_BINDING);
        } catch (Exception e) {
