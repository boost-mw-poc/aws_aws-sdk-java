...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.repostspace.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.repostspace.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.repostspace.model.ValidationException validationException = new com.amazonaws.services.repostspace.model.ValidationException(
                null);
