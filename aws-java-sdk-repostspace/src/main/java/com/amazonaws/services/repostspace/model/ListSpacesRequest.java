...
public class ListSpacesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The token for the next set of private re:Posts to return. You receive this token from a previous ListSpaces
     * operation.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The maximum number of private re:Posts to include in the results.
     */
     ...
     * </p>
     * 
     * @return The token for the next set of private re:Posts to return. You receive this token from a previous
     *         ListSpaces operation.
     */
