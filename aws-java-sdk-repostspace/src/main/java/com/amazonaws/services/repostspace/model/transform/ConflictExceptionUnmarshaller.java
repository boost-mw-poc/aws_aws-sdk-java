...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.repostspace.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.repostspace.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.repostspace.model.ConflictException conflictException = new com.amazonaws.services.repostspace.model.ConflictException(null);
