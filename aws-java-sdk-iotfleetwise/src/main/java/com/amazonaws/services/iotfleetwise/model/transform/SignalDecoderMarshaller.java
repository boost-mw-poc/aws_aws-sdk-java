...
/**
 * SignalDecoderMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class SignalDecoderMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> CANSIGNAL_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static SignalDecoderMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SignalDecoder signalDecoder, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(signalDecoder.getFullyQualifiedName(), FULLYQUALIFIEDNAME_BINDING);
            protocolMarshaller.marshall(signalDecoder.getType(), TYPE_BINDING);
