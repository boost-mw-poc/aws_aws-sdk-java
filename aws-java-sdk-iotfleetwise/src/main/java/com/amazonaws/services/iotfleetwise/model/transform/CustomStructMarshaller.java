...
/**
 * CustomStructMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CustomStructMarshaller {
    ...
    private static final CustomStructMarshaller instance = new CustomStructMarshaller();

    public static CustomStructMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CustomStruct customStruct, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(customStruct.getFullyQualifiedName(), FULLYQUALIFIEDNAME_BINDING);
            protocolMarshaller.marshall(customStruct.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(customStruct.getDeprecationMessage(), DEPRECATIONMESSAGE_BINDING);
            protocolMarshaller.marshall(customStruct.getComment(), COMMENT_BINDING);
        } catch (Exception e) {
