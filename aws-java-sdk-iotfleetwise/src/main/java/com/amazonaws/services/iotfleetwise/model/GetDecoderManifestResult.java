...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/iotfleetwise-2021-06-17/GetDecoderManifest" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetDecoderManifestResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the decoder manifest.
     */
    ...
    public GetDecoderManifestResult withCreationTime(java.util.Date creationTime) {
    ...
    public GetDecoderManifestResult withLastModificationTime(java.util.Date lastModificationTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetDecoderManifestResult == false)
            return false;
        GetDecoderManifestResult other = (GetDecoderManifestResult) obj;
    ...
    public GetDecoderManifestResult clone() {
        try {
            return (GetDecoderManifestResult) super.clone();
