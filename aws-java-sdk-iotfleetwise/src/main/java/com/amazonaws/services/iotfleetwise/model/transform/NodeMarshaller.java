...
public class NodeMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> BRANCH_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("branch").build();
    private static final MarshallingInfo<StructuredPojo> SENSOR_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("sensor").build();
    private static final MarshallingInfo<StructuredPojo> ACTUATOR_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public void marshall(Node node, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(node.getBranch(), BRANCH_BINDING);
