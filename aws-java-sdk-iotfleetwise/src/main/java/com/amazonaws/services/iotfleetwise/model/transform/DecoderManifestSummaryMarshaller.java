...
/**
 * DecoderManifestSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class DecoderManifestSummaryMarshaller {
    ...
    public static DecoderManifestSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(DecoderManifestSummary decoderManifestSummary, ProtocolMarshaller protocolMarshaller) {

        if (decoderManifestSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(decoderManifestSummary.getName(), NAME_BINDING);
            protocolMarshaller.marshall(decoderManifestSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(decoderManifestSummary.getModelManifestArn(), MODELMANIFESTARN_BINDING);
            protocolMarshaller.marshall(decoderManifestSummary.getDescription(), DESCRIPTION_BINDING);
