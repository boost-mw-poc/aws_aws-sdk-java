...
public class ListRecommendationsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setItems(java.util.Collection<Recommendation> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<Recommendation>(items);
    }
    ...
    public ListRecommendationsResult withItems(Recommendation... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<Recommendation>(items.length));
        }
        for (Recommendation ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListRecommendationsResult withItems(java.util.Collection<Recommendation> items) {
        setItems(items);
        return this;
    }
