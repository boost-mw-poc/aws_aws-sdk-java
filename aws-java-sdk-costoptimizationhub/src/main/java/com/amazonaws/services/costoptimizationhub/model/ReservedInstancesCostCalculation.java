 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/ReservedInstancesCostCalculation"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ReservedInstancesCostCalculation implements Serializable, Cloneable, StructuredPojo {
    ...
    public ReservedInstancesPricing getPricing() {
        return this.pricing;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ReservedInstancesCostCalculation == false)
            return false;
    ...
    @Override
    public ReservedInstancesCostCalculation clone() {
        try {
            return (ReservedInstancesCostCalculation) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.ReservedInstancesCostCalculationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
