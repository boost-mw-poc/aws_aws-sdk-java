        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("configuration", targetDepth)) {
                    context.nextToken();
                    ebsVolume.setConfiguration(EbsVolumeConfigurationJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("costCalculation", targetDepth)) {
                    context.nextToken();
                    ebsVolume.setCostCalculation(ResourceCostCalculationJsonUnmarshaller.getInstance().unmarshall(context));
                }
