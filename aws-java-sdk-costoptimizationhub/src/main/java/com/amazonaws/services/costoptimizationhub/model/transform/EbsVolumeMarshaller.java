...
public class EbsVolumeMarshaller {
    ...
    public void marshall(EbsVolume ebsVolume, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(ebsVolume.getConfiguration(), CONFIGURATION_BINDING);
            protocolMarshaller.marshall(ebsVolume.getCostCalculation(), COSTCALCULATION_BINDING);
        } catch (Exception e) {
