 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cost-optimization-hub-2022-07-26/Ec2AutoScalingGroupConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class Ec2AutoScalingGroupConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Ec2AutoScalingGroupConfiguration == false)
            return false;
    ...
    public Ec2AutoScalingGroupConfiguration clone() {
        try {
            return (Ec2AutoScalingGroupConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.costoptimizationhub.model.transform.Ec2AutoScalingGroupConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
