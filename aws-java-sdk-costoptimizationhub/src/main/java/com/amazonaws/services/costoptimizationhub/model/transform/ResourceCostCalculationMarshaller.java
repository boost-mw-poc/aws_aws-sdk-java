...
/**
 * ResourceCostCalculationMarshaller
 */
...
public class ResourceCostCalculationMarshaller {
    ...
    public static ResourceCostCalculationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ResourceCostCalculation resourceCostCalculation, ProtocolMarshaller protocolMarshaller) {

        if (resourceCostCalculation == null) {
