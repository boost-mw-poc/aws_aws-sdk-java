...
public class DisableUserRequestMarshaller {
    ...
    public void marshall(DisableUserRequest disableUserRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(disableUserRequest.getUserId(), USERID_BINDING);
            protocolMarshaller.marshall(disableUserRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
