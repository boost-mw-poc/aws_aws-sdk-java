...
/**
 * PutActionsResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PutActionsResultJsonUnmarshaller implements Unmarshaller<PutActionsResult, JsonUnmarshallerContext> {

    public PutActionsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        PutActionsResult putActionsResult = new PutActionsResult();

        return putActionsResult;
    }
