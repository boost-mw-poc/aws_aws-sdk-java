...
public class DataSourceSummaryMarshaller {
    ...
    public void marshall(DataSourceSummary dataSourceSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(dataSourceSummary.getArn(), ARN_BINDING);
            ...
            protocolMarshaller.marshall(dataSourceSummary.getCreatedTime(), CREATEDTIME_BINDING);
            protocolMarshaller.marshall(dataSourceSummary.getLastUpdatedTime(), LASTUPDATEDTIME_BINDING);
        } catch (Exception e) {
