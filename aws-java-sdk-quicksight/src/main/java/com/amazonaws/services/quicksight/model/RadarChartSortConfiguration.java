 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/RadarChartSortConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RadarChartSortConfiguration implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The category sort options of a radar chart.
     */
    ...
    public RadarChartSortConfiguration withCategorySort(FieldSortOptions... categorySort) {
    ...
    public RadarChartSortConfiguration withCategorySort(java.util.Collection<FieldSortOptions> categorySort) {
     ...
     * </p>
     * 
     * @return The category items limit for a radar chart.
     */
     ...
     * </p>
     * 
     * @return The color sort configuration of a radar chart.
     */
    ...
    public RadarChartSortConfiguration withColorSort(FieldSortOptions... colorSort) {
    ...
    public RadarChartSortConfiguration withColorSort(java.util.Collection<FieldSortOptions> colorSort) {
     ...
     * </p>
     * 
     * @return The color items limit of a radar chart.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RadarChartSortConfiguration == false)
            return false;
        RadarChartSortConfiguration other = (RadarChartSortConfiguration) obj;
    ...
    public RadarChartSortConfiguration clone() {
        try {
            return (RadarChartSortConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.RadarChartSortConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
