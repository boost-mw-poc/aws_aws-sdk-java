...
public class DashboardError implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Lists the violated entities that caused the dashboard error.
     */
    ...
    public DashboardError withViolatedEntities(Entity... violatedEntities) {
    ...
    public DashboardError withViolatedEntities(java.util.Collection<Entity> violatedEntities) {
