...
public class BatchDeleteTopicReviewedAnswerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public BatchDeleteTopicReviewedAnswerResult withSucceededAnswers(java.util.Collection<SucceededTopicReviewedAnswer> succeededAnswers) {
    ...
    public BatchDeleteTopicReviewedAnswerResult withInvalidAnswers(java.util.Collection<InvalidTopicReviewedAnswer> invalidAnswers) {
