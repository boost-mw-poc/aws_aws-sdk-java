...
public class ListTopicReviewedAnswersResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<TopicReviewedAnswer> answers;
    /**
     * <p>
    ...
    public java.util.List<TopicReviewedAnswer> getAnswers() {
        return answers;
    }
    ...
    public void setAnswers(java.util.Collection<TopicReviewedAnswer> answers) {
        if (answers == null) {
            this.answers = null;
            return;
        }

        this.answers = new java.util.ArrayList<TopicReviewedAnswer>(answers);
    }
    ...
    public ListTopicReviewedAnswersResult withAnswers(TopicReviewedAnswer... answers) {
        if (this.answers == null) {
            setAnswers(new java.util.ArrayList<TopicReviewedAnswer>(answers.length));
        }
    ...
    public ListTopicReviewedAnswersResult withAnswers(java.util.Collection<TopicReviewedAnswer> answers) {
        setAnswers(answers);
        return this;
    }
