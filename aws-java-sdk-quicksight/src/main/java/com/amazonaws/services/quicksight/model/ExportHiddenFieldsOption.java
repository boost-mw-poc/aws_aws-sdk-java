...
public class ExportHiddenFieldsOption implements Serializable, Cloneable, StructuredPojo {
    ...
    public ExportHiddenFieldsOption withAvailabilityStatus(String availabilityStatus) {
    ...
    public ExportHiddenFieldsOption withAvailabilityStatus(DashboardBehavior availabilityStatus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExportHiddenFieldsOption == false)
            return false;
        ExportHiddenFieldsOption other = (ExportHiddenFieldsOption) obj;
    ...
    @Override
    public ExportHiddenFieldsOption clone() {
        try {
            return (ExportHiddenFieldsOption) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.ExportHiddenFieldsOptionMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
