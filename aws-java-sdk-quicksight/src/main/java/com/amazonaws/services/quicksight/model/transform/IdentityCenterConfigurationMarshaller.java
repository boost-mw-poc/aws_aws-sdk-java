...
public class IdentityCenterConfigurationMarshaller {
    ...
    private static final MarshallingInfo<Boolean> ENABLEIDENTITYPROPAGATION_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("EnableIdentityPropagation").build();
    ...
    public void marshall(IdentityCenterConfiguration identityCenterConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(identityCenterConfiguration.getEnableIdentityPropagation(), ENABLEIDENTITYPROPAGATION_BINDING);
        } catch (Exception e) {
