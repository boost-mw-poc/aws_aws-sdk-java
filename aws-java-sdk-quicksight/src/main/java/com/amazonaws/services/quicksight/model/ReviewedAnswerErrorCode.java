...
public enum ReviewedAnswerErrorCode {
    ...
    private ReviewedAnswerErrorCode(String value) {
        this.value = value;
    }
     ...
     * @param value
     *        real value
     * @return ReviewedAnswerErrorCode corresponding to the value
     *
    ...
    public static ReviewedAnswerErrorCode fromValue(String value) {
        ...
        for (ReviewedAnswerErrorCode enumEntry : ReviewedAnswerErrorCode.values()) {
