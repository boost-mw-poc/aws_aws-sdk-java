...
/**
 * RadarChartSortConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RadarChartSortConfigurationMarshaller {
    ...
    private static final RadarChartSortConfigurationMarshaller instance = new RadarChartSortConfigurationMarshaller();

    public static RadarChartSortConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RadarChartSortConfiguration radarChartSortConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (radarChartSortConfiguration == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(radarChartSortConfiguration.getCategorySort(), CATEGORYSORT_BINDING);
            protocolMarshaller.marshall(radarChartSortConfiguration.getCategoryItemsLimit(), CATEGORYITEMSLIMIT_BINDING);
            protocolMarshaller.marshall(radarChartSortConfiguration.getColorSort(), COLORSORT_BINDING);
            protocolMarshaller.marshall(radarChartSortConfiguration.getColorItemsLimit(), COLORITEMSLIMIT_BINDING);
        } catch (Exception e) {
