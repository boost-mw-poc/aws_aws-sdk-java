 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/quicksight-2018-04-01/RadarChartVisual" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RadarChartVisual implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private RadarChartConfiguration chartConfiguration;
    /**
     * <p>
    ...
    public RadarChartVisual withVisualId(String visualId) {
    ...
    public RadarChartVisual withTitle(VisualTitleLabelOptions title) {
        setTitle(title);
        return this;
    }
    ...
    public RadarChartVisual withSubtitle(VisualSubtitleLabelOptions subtitle) {
    ...
    public void setChartConfiguration(RadarChartConfiguration chartConfiguration) {
    ...
    public RadarChartConfiguration getChartConfiguration() {
    ...
    public RadarChartVisual withChartConfiguration(RadarChartConfiguration chartConfiguration) {
    ...
    public RadarChartVisual withActions(VisualCustomAction... actions) {
    ...
    public RadarChartVisual withActions(java.util.Collection<VisualCustomAction> actions) {
        setActions(actions);
        return this;
    }
    ...
    public RadarChartVisual withColumnHierarchies(ColumnHierarchy... columnHierarchies) {
    ...
    public RadarChartVisual withColumnHierarchies(java.util.Collection<ColumnHierarchy> columnHierarchies) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RadarChartVisual == false)
            return false;
        RadarChartVisual other = (RadarChartVisual) obj;
    ...
    @Override
    public RadarChartVisual clone() {
        try {
            return (RadarChartVisual) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.quicksight.model.transform.RadarChartVisualMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
