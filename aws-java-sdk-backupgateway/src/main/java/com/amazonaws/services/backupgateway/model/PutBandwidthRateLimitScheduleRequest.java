...
public class PutBandwidthRateLimitScheduleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public PutBandwidthRateLimitScheduleRequest withBandwidthRateLimitIntervals(BandwidthRateLimitInterval... bandwidthRateLimitIntervals) {
    ...
    public PutBandwidthRateLimitScheduleRequest withBandwidthRateLimitIntervals(java.util.Collection<BandwidthRateLimitInterval> bandwidthRateLimitIntervals) {
    ...
    public PutBandwidthRateLimitScheduleRequest withGatewayArn(String gatewayArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PutBandwidthRateLimitScheduleRequest == false)
            return false;
        PutBandwidthRateLimitScheduleRequest other = (PutBandwidthRateLimitScheduleRequest) obj;
