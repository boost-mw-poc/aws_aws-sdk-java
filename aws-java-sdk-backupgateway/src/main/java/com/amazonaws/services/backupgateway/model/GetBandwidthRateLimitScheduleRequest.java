...
public class GetBandwidthRateLimitScheduleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetBandwidthRateLimitScheduleRequest withGatewayArn(String gatewayArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBandwidthRateLimitScheduleRequest == false)
            return false;
        GetBandwidthRateLimitScheduleRequest other = (GetBandwidthRateLimitScheduleRequest) obj;
    ...
    @Override
    public GetBandwidthRateLimitScheduleRequest clone() {
        return (GetBandwidthRateLimitScheduleRequest) super.clone();
    }
