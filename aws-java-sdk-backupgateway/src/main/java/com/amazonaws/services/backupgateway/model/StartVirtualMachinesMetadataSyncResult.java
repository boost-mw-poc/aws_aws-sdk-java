...
public class StartVirtualMachinesMetadataSyncResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartVirtualMachinesMetadataSyncResult == false)
            return false;
        StartVirtualMachinesMetadataSyncResult other = (StartVirtualMachinesMetadataSyncResult) obj;
    ...
    public StartVirtualMachinesMetadataSyncResult clone() {
        try {
            return (StartVirtualMachinesMetadataSyncResult) super.clone();
