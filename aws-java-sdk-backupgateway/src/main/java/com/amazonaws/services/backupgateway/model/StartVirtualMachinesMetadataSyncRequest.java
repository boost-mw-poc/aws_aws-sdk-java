...
public class StartVirtualMachinesMetadataSyncRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartVirtualMachinesMetadataSyncRequest withHypervisorArn(String hypervisorArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartVirtualMachinesMetadataSyncRequest == false)
            return false;
        StartVirtualMachinesMetadataSyncRequest other = (StartVirtualMachinesMetadataSyncRequest) obj;
    ...
    @Override
    public StartVirtualMachinesMetadataSyncRequest clone() {
        return (StartVirtualMachinesMetadataSyncRequest) super.clone();
    }
