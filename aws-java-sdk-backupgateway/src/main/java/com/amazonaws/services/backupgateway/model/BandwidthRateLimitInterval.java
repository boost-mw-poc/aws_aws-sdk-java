 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/backup-gateway-2021-01-01/BandwidthRateLimitInterval"
...
public class BandwidthRateLimitInterval implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setDaysOfWeek(java.util.Collection<Integer> daysOfWeek) {
        ...
        this.daysOfWeek = new java.util.ArrayList<Integer>(daysOfWeek);
    }
    ...
    public BandwidthRateLimitInterval withDaysOfWeek(Integer... daysOfWeek) {
        if (this.daysOfWeek == null) {
            setDaysOfWeek(new java.util.ArrayList<Integer>(daysOfWeek.length));
        }
