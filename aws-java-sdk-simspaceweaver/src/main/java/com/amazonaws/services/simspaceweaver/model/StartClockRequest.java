...
public class StartClockRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartClockRequest withSimulation(String simulation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartClockRequest == false)
            return false;
        StartClockRequest other = (StartClockRequest) obj;
    ...
    @Override
    public StartClockRequest clone() {
        return (StartClockRequest) super.clone();
    }
