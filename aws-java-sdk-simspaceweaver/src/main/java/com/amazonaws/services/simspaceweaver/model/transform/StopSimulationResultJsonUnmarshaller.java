...
/**
 * StopSimulationResult JSON Unmarshaller
 */
...
public class StopSimulationResultJsonUnmarshaller implements Unmarshaller<StopSimulationResult, JsonUnmarshallerContext> {
    ...
    public StopSimulationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopSimulationResult stopSimulationResult = new StopSimulationResult();
