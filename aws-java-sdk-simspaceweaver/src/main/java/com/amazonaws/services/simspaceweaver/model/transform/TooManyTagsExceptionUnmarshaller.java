...
public class TooManyTagsExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private TooManyTagsExceptionUnmarshaller() {
        super(com.amazonaws.services.simspaceweaver.model.TooManyTagsException.class, "TooManyTagsException");
    }

    @Override
    public com.amazonaws.services.simspaceweaver.model.TooManyTagsException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.simspaceweaver.model.TooManyTagsException tooManyTagsException = new com.amazonaws.services.simspaceweaver.model.TooManyTagsException(
                null);
