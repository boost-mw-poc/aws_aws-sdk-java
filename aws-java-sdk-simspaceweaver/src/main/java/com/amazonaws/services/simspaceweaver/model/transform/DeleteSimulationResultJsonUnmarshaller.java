...
/**
 * DeleteSimulationResult JSON Unmarshaller
 */
...
public class DeleteSimulationResultJsonUnmarshaller implements Unmarshaller<DeleteSimulationResult, JsonUnmarshallerContext> {
    ...
    public DeleteSimulationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSimulationResult deleteSimulationResult = new DeleteSimulationResult();
