...
public class DescribeSimulationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeSimulationRequest withSimulation(String simulation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeSimulationRequest == false)
            return false;
        DescribeSimulationRequest other = (DescribeSimulationRequest) obj;
    ...
    @Override
    public DescribeSimulationRequest clone() {
        return (DescribeSimulationRequest) super.clone();
    }
