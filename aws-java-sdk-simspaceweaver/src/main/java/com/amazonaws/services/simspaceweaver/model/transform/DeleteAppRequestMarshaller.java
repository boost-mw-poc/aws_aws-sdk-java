...
public class DeleteAppRequestMarshaller {
    ...
    public void marshall(DeleteAppRequest deleteAppRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteAppRequest.getApp(), APP_BINDING);
            protocolMarshaller.marshall(deleteAppRequest.getDomain(), DOMAIN_BINDING);
            protocolMarshaller.marshall(deleteAppRequest.getSimulation(), SIMULATION_BINDING);
        } catch (Exception e) {
