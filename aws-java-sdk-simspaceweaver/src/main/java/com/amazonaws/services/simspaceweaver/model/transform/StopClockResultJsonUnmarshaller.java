...
/**
 * StopClockResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopClockResultJsonUnmarshaller implements Unmarshaller<StopClockResult, JsonUnmarshallerContext> {

    public StopClockResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        StopClockResult stopClockResult = new StopClockResult();
