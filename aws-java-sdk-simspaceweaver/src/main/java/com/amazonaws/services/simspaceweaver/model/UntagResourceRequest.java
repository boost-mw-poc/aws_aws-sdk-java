...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The Amazon Resource Name (ARN) of the resource that you want to remove tags from. For more information about
     * ARNs, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource
     ...
     * 
     * @param resourceArn
     *        The Amazon Resource Name (ARN) of the resource that you want to remove tags from. For more information
     *        about ARNs, see <a
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the resource that you want to remove tags from. For more information
     *         about ARNs, see <a
     *         href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html">Amazon Resource Names
     *         (ARNs)</a> in the <i>Amazon Web Services General Reference</i>.
     */
