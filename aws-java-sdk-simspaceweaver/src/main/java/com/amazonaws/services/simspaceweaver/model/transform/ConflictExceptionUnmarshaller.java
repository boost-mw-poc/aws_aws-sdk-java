...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.simspaceweaver.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.simspaceweaver.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.simspaceweaver.model.ConflictException conflictException = new com.amazonaws.services.simspaceweaver.model.ConflictException(
                null);
