...
public class ServiceSummaryMarshaller {
    ...
    private static final MarshallingInfo<List> ATTRIBUTEMAPS_BINDING = MarshallingInfo.builder(MarshallingType.LIST).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(ServiceSummary serviceSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(serviceSummary.getKeyAttributes(), KEYATTRIBUTES_BINDING);
            protocolMarshaller.marshall(serviceSummary.getAttributeMaps(), ATTRIBUTEMAPS_BINDING);
            protocolMarshaller.marshall(serviceSummary.getMetricReferences(), METRICREFERENCES_BINDING);
        } catch (Exception e) {
