...
public class ListServiceDependentsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListServiceDependentsRequest withStartTime(java.util.Date startTime) {
    ...
    public ListServiceDependentsRequest withEndTime(java.util.Date endTime) {
        setEndTime(endTime);
        return this;
    }
    ...
    public ListServiceDependentsRequest withKeyAttributes(java.util.Map<String, String> keyAttributes) {
     ...
     *
     * @see ListServiceDependentsRequest#withKeyAttributes
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServiceDependentsRequest == false)
            return false;
        ListServiceDependentsRequest other = (ListServiceDependentsRequest) obj;
    ...
    public ListServiceDependentsRequest clone() {
        return (ListServiceDependentsRequest) super.clone();
    }
