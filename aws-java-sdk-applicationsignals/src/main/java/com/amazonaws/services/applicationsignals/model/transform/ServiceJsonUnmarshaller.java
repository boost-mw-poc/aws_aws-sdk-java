        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KeyAttributes", targetDepth)) {
                    context.nextToken();
                    service.setKeyAttributes(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context.getUnmarshaller(String.class))
                            .unmarshall(context));
                }
                if (context.testExpression("AttributeMaps", targetDepth)) {
                    context.nextToken();
                    service.setAttributeMaps(new ListUnmarshaller<java.util.Map<String, String>>(new MapUnmarshaller<String, String>(context
                ...
                if (context.testExpression("MetricReferences", targetDepth)) {
                    context.nextToken();
                    service.setMetricReferences(new ListUnmarshaller<MetricReference>(MetricReferenceJsonUnmarshaller.getInstance())

                    .unmarshall(context));
                }
                if (context.testExpression("LogGroupReferences", targetDepth)) {
                    context.nextToken();
                    service.setLogGroupReferences(new ListUnmarshaller<java.util.Map<String, String>>(new MapUnmarshaller<String, String>(context
                            .getUnmarshaller(String.class), context.getUnmarshaller(String.class)))
