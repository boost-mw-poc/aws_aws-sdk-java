...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/application-signals-2024-04-15/UntagResource" target="_top">AWS
 *      API Documentation</a>
 */
...
public class UntagResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * <code>arn:aws:cloudwatch:<i>Region</i>:<i>account-id</i>:slo:<i>slo-name</i> </code>
     * </p>
     * <p>
     ...
     * 
     * @param resourceArn
     *        The Amazon Resource Name (ARN) of the CloudWatch resource that you want to delete tags from.</p>
     *        <p>
     *        The ARN format of an Application Signals SLO is
     *        <code>arn:aws:cloudwatch:<i>Region</i>:<i>account-id</i>:slo:<i>slo-name</i> </code>
     *        </p>
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the CloudWatch resource that you want to delete tags from.</p>
     *         <p>
     *         The ARN format of an Application Signals SLO is
     *         <code>arn:aws:cloudwatch:<i>Region</i>:<i>account-id</i>:slo:<i>slo-name</i> </code>
     *         </p>
