...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationsignals.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.applicationsignals.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.applicationsignals.model.ValidationException validationException = new com.amazonaws.services.applicationsignals.model.ValidationException(
                null);
