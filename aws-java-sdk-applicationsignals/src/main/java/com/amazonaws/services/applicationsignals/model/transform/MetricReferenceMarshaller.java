...
/**
 * MetricReferenceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MetricReferenceMarshaller {
    ...
    private static final MetricReferenceMarshaller instance = new MetricReferenceMarshaller();

    public static MetricReferenceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(MetricReference metricReference, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(metricReference.getNamespace(), NAMESPACE_BINDING);
            protocolMarshaller.marshall(metricReference.getMetricType(), METRICTYPE_BINDING);
            protocolMarshaller.marshall(metricReference.getDimensions(), DIMENSIONS_BINDING);
            protocolMarshaller.marshall(metricReference.getMetricName(), METRICNAME_BINDING);
        } catch (Exception e) {
