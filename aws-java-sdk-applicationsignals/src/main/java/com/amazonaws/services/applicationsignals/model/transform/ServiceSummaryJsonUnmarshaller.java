        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("KeyAttributes", targetDepth)) {
                    context.nextToken();
                    serviceSummary.setKeyAttributes(new MapUnmarshaller<String, String>(context.getUnmarshaller(String.class), context
                            .getUnmarshaller(String.class)).unmarshall(context));
                }
                if (context.testExpression("AttributeMaps", targetDepth)) {
                    context.nextToken();
                    serviceSummary.setAttributeMaps(new ListUnmarshaller<java.util.Map<String, String>>(new MapUnmarshaller<String, String>(context
                ...
                if (context.testExpression("MetricReferences", targetDepth)) {
                    context.nextToken();
                    serviceSummary.setMetricReferences(new ListUnmarshaller<MetricReference>(MetricReferenceJsonUnmarshaller.getInstance())
