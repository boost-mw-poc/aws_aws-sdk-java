...
public class ListServiceOperationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListServiceOperationsRequest withStartTime(java.util.Date startTime) {
    ...
    public ListServiceOperationsRequest withEndTime(java.util.Date endTime) {
        setEndTime(endTime);
        return this;
    }
    ...
    public ListServiceOperationsRequest withKeyAttributes(java.util.Map<String, String> keyAttributes) {
     ...
     *
     * @see ListServiceOperationsRequest#withKeyAttributes
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListServiceOperationsRequest == false)
            return false;
        ListServiceOperationsRequest other = (ListServiceOperationsRequest) obj;
    ...
    public ListServiceOperationsRequest clone() {
        return (ListServiceOperationsRequest) super.clone();
    }
