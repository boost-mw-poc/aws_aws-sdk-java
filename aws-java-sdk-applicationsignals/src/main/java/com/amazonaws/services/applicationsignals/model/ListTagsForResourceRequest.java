...
public class ListTagsForResourceRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param resourceArn
     *        The Amazon Resource Name (ARN) of the CloudWatch resource that you want to view tags for.</p>
     *        <p>
     *        The ARN format of an Application Signals SLO is
     *        <code>arn:aws:cloudwatch:<i>Region</i>:<i>account-id</i>:slo:<i>slo-name</i> </code>
     *        </p>
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the CloudWatch resource that you want to view tags for.</p>
     *         <p>
     *         The ARN format of an Application Signals SLO is
     *         <code>arn:aws:cloudwatch:<i>Region</i>:<i>account-id</i>:slo:<i>slo-name</i> </code>
     *         </p>
