...
/**
 * DeleteServiceLevelObjectiveResult JSON Unmarshaller
 */
...
public class DeleteServiceLevelObjectiveResultJsonUnmarshaller implements Unmarshaller<DeleteServiceLevelObjectiveResult, JsonUnmarshallerContext> {
    ...
    public DeleteServiceLevelObjectiveResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteServiceLevelObjectiveResult deleteServiceLevelObjectiveResult = new DeleteServiceLevelObjectiveResult();
