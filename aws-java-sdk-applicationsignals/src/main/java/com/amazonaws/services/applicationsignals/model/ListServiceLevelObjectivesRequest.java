...
public class ListServiceLevelObjectivesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * 
     * @param keyAttributes
     *        You can use this optional field to specify which services you want to retrieve SLO information for.</p>
     *        <p>
     *        This is a string-to-string map. It can include the following fields.
     *        </p>
     *        <ul>
    ...
    public ListServiceLevelObjectivesRequest withKeyAttributes(java.util.Map<String, String> keyAttributes) {
