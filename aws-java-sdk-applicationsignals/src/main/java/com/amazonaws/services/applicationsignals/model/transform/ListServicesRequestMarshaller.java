...
public class ListServicesRequestMarshaller {
    ...
    public void marshall(ListServicesRequest listServicesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listServicesRequest.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(listServicesRequest.getEndTime(), ENDTIME_BINDING);
