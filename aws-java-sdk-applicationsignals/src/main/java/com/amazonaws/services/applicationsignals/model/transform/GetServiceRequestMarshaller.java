...
public class GetServiceRequestMarshaller {
    ...
    public void marshall(GetServiceRequest getServiceRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getServiceRequest.getStartTime(), STARTTIME_BINDING);
            protocolMarshaller.marshall(getServiceRequest.getEndTime(), ENDTIME_BINDING);
            protocolMarshaller.marshall(getServiceRequest.getKeyAttributes(), KEYATTRIBUTES_BINDING);
        } catch (Exception e) {
