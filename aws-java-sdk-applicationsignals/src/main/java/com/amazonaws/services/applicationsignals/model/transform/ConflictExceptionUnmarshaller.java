...
public class ConflictExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ConflictExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationsignals.model.ConflictException.class, "ConflictException");
    }

    @Override
    public com.amazonaws.services.applicationsignals.model.ConflictException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.applicationsignals.model.ConflictException conflictException = new com.amazonaws.services.applicationsignals.model.ConflictException(
                null);
