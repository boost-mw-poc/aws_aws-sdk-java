 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/application-signals-2024-04-15/ServiceSummary" target="_top">AWS
 *      API Documentation</a>
 */
...
public class ServiceSummary implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * This is a string-to-string map that help identify the objects discovered by Application Signals. It can include
     ...
     * </ul>
     * 
     * @return This is a string-to-string map that help identify the objects discovered by Application Signals. It can
    ...
    public ServiceSummary withKeyAttributes(java.util.Map<String, String> keyAttributes) {
     ...
     *
     * @see ServiceSummary#withKeyAttributes
    ...
    public ServiceSummary withAttributeMaps(java.util.Map<String, String>... attributeMaps) {
    ...
    public ServiceSummary withAttributeMaps(java.util.Collection<java.util.Map<String, String>> attributeMaps) {
    ...
    public ServiceSummary withMetricReferences(MetricReference... metricReferences) {
    ...
    public ServiceSummary withMetricReferences(java.util.Collection<MetricReference> metricReferences) {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.applicationsignals.model.transform.ServiceSummaryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
