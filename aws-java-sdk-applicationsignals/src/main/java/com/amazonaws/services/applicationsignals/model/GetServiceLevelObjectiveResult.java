...
public class GetServiceLevelObjectiveResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetServiceLevelObjectiveResult == false)
            return false;
        GetServiceLevelObjectiveResult other = (GetServiceLevelObjectiveResult) obj;
    ...
    public GetServiceLevelObjectiveResult clone() {
        try {
            return (GetServiceLevelObjectiveResult) super.clone();
