...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.applicationsignals.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.applicationsignals.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.applicationsignals.model.ThrottlingException throttlingException = new com.amazonaws.services.applicationsignals.model.ThrottlingException(
                null);
