...
public class DeleteEnvironmentRequestMarshaller {
    ...
    public void marshall(DeleteEnvironmentRequest deleteEnvironmentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteEnvironmentRequest.getId(), ID_BINDING);
            protocolMarshaller.marshall(deleteEnvironmentRequest.getClientToken(), CLIENTTOKEN_BINDING);
        } catch (Exception e) {
