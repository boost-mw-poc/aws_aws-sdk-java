...
public class GetReadSetActivationJobFunction implements SdkFunction<GetReadSetActivationJobRequest, GetReadSetActivationJobResult> {
    ...
    /**
     * Constructs a new GetReadSetActivationJobFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetReadSetActivationJobFunction(AmazonOmics client) {
        this.client = client;
    }
    ...
    public GetReadSetActivationJobResult apply(GetReadSetActivationJobRequest getReadSetActivationJobRequest) {
        return client.getReadSetActivationJob(getReadSetActivationJobRequest);
    }
}
