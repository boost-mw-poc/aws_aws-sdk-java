...
class ReadSetActivationJobCompleted {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
         ...
         */
        @Override
        public boolean matches(GetReadSetActivationJobResult result) {
    ...
    static class IsSUBMITTEDMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIN_PROGRESSMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLINGMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLEDMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCOMPLETED_WITH_FAILURESMatcher extends WaiterAcceptor<GetReadSetActivationJobResult> {
        private static final JsonNode expectedResult;
