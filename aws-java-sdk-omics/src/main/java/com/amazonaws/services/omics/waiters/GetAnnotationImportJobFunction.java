...
public class GetAnnotationImportJobFunction implements SdkFunction<GetAnnotationImportJobRequest, GetAnnotationImportJobResult> {
    ...
    /**
     * Constructs a new GetAnnotationImportJobFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetAnnotationImportJobFunction(AmazonOmics client) {
        this.client = client;
    }
    ...
    public GetAnnotationImportJobResult apply(GetAnnotationImportJobRequest getAnnotationImportJobRequest) {
        return client.getAnnotationImportJob(getAnnotationImportJobRequest);
    }
}
