...
/**
 * StartReferenceImportJobSourceItemMarshaller
 */
...
public class StartReferenceImportJobSourceItemMarshaller {
    ...
    private static final StartReferenceImportJobSourceItemMarshaller instance = new StartReferenceImportJobSourceItemMarshaller();

    public static StartReferenceImportJobSourceItemMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(StartReferenceImportJobSourceItem startReferenceImportJobSourceItem, ProtocolMarshaller protocolMarshaller) {

        if (startReferenceImportJobSourceItem == null) {
