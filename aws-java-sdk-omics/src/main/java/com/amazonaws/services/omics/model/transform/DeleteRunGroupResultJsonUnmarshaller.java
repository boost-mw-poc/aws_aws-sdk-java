...
/**
 * DeleteRunGroupResult JSON Unmarshaller
 */
...
public class DeleteRunGroupResultJsonUnmarshaller implements Unmarshaller<DeleteRunGroupResult, JsonUnmarshallerContext> {
    ...
    public DeleteRunGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteRunGroupResult deleteRunGroupResult = new DeleteRunGroupResult();
