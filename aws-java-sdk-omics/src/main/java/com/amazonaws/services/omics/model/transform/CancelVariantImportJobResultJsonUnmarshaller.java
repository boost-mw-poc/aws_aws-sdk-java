...
/**
 * CancelVariantImportJobResult JSON Unmarshaller
 */
...
public class CancelVariantImportJobResultJsonUnmarshaller implements Unmarshaller<CancelVariantImportJobResult, JsonUnmarshallerContext> {
    ...
    public CancelVariantImportJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelVariantImportJobResult cancelVariantImportJobResult = new CancelVariantImportJobResult();
