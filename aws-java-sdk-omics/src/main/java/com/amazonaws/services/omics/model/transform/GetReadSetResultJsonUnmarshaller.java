...
/**
 * GetReadSetResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetReadSetResultJsonUnmarshaller implements Unmarshaller<GetReadSetResult, JsonUnmarshallerContext> {

    public GetReadSetResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetReadSetResult getReadSetResult = new GetReadSetResult();

        getReadSetResult.setPayload(context.getHttpResponse().getContent());
