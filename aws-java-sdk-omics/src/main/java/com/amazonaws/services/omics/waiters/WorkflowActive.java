...
class WorkflowActive {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<GetWorkflowResult> {
         ...
         */
        @Override
        public boolean matches(GetWorkflowResult result) {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<GetWorkflowResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATINGMatcher extends WaiterAcceptor<GetWorkflowResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetWorkflowResult> {
        private static final JsonNode expectedResult;
