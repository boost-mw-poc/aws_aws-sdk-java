...
class ReadSetExportJobCompleted {
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
         ...
         */
        @Override
        public boolean matches(GetReadSetExportJobResult result) {
    ...
    static class IsSUBMITTEDMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsIN_PROGRESSMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLINGMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLEDMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCOMPLETED_WITH_FAILURESMatcher extends WaiterAcceptor<GetReadSetExportJobResult> {
        private static final JsonNode expectedResult;
