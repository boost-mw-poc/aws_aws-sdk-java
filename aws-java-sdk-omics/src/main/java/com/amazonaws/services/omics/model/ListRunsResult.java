...
public class ListRunsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<RunListItem> items;
    /**
     * <p>
    ...
    public java.util.List<RunListItem> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<RunListItem> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<RunListItem>(items);
    }
    ...
    public ListRunsResult withItems(RunListItem... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<RunListItem>(items.length));
        }
        for (RunListItem ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListRunsResult withItems(java.util.Collection<RunListItem> items) {
        setItems(items);
        return this;
    }
