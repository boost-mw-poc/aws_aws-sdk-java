...
class AnnotationImportJobCreated {
    ...
    static class IsSUBMITTEDMatcher extends WaiterAcceptor<GetAnnotationImportJobResult> {
         ...
         */
        @Override
        public boolean matches(GetAnnotationImportJobResult result) {
    ...
    static class IsIN_PROGRESSMatcher extends WaiterAcceptor<GetAnnotationImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetAnnotationImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLEDMatcher extends WaiterAcceptor<GetAnnotationImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetAnnotationImportJobResult> {
        private static final JsonNode expectedResult;
