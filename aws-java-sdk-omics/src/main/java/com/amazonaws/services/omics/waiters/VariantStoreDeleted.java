...
class VariantStoreDeleted {
    ...
    static class IsDELETEDMatcher extends WaiterAcceptor<GetVariantStoreResult> {
    ...
    static class IsResourceNotFoundExceptionMatcher extends WaiterAcceptor<GetVariantStoreResult> {
        /**
    ...
    static class IsDELETINGMatcher extends WaiterAcceptor<GetVariantStoreResult> {
        private static final JsonNode expectedResult;
