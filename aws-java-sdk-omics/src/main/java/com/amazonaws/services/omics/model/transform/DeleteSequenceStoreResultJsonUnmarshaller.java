...
/**
 * DeleteSequenceStoreResult JSON Unmarshaller
 */
...
public class DeleteSequenceStoreResultJsonUnmarshaller implements Unmarshaller<DeleteSequenceStoreResult, JsonUnmarshallerContext> {
    ...
    public DeleteSequenceStoreResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSequenceStoreResult deleteSequenceStoreResult = new DeleteSequenceStoreResult();
