...
public class GetVariantImportJobFunction implements SdkFunction<GetVariantImportJobRequest, GetVariantImportJobResult> {
    ...
    /**
     * Constructs a new GetVariantImportJobFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetVariantImportJobFunction(AmazonOmics client) {
        this.client = client;
    }
    ...
    public GetVariantImportJobResult apply(GetVariantImportJobRequest getVariantImportJobRequest) {
        return client.getVariantImportJob(getVariantImportJobRequest);
    }
}
