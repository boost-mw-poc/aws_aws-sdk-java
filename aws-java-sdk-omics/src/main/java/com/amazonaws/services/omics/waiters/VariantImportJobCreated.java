...
class VariantImportJobCreated {
    ...
    static class IsSUBMITTEDMatcher extends WaiterAcceptor<GetVariantImportJobResult> {
         ...
         */
        @Override
        public boolean matches(GetVariantImportJobResult result) {
    ...
    static class IsIN_PROGRESSMatcher extends WaiterAcceptor<GetVariantImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetVariantImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCANCELLEDMatcher extends WaiterAcceptor<GetVariantImportJobResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsCOMPLETEDMatcher extends WaiterAcceptor<GetVariantImportJobResult> {
        private static final JsonNode expectedResult;
