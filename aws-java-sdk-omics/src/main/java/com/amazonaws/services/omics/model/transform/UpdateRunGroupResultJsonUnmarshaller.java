...
/**
 * UpdateRunGroupResult JSON Unmarshaller
 */
...
public class UpdateRunGroupResultJsonUnmarshaller implements Unmarshaller<UpdateRunGroupResult, JsonUnmarshallerContext> {
    ...
    public UpdateRunGroupResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateRunGroupResult updateRunGroupResult = new UpdateRunGroupResult();
