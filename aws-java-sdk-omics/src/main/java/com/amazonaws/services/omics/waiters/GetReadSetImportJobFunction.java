...
public class GetReadSetImportJobFunction implements SdkFunction<GetReadSetImportJobRequest, GetReadSetImportJobResult> {
    ...
    /**
     * Constructs a new GetReadSetImportJobFunction with the given client
     * 
     * @param client
     *        Service client
     */
    public GetReadSetImportJobFunction(AmazonOmics client) {
        this.client = client;
    }
    ...
    public GetReadSetImportJobResult apply(GetReadSetImportJobRequest getReadSetImportJobRequest) {
        return client.getReadSetImportJob(getReadSetImportJobRequest);
    }
}
