...
class VariantStoreCreated {
    ...
    static class IsACTIVEMatcher extends WaiterAcceptor<GetVariantStoreResult> {
         ...
         */
        @Override
        public boolean matches(GetVariantStoreResult result) {
    ...
    static class IsCREATINGMatcher extends WaiterAcceptor<GetVariantStoreResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsUPDATINGMatcher extends WaiterAcceptor<GetVariantStoreResult> {
        private static final JsonNode expectedResult;
    ...
    static class IsFAILEDMatcher extends WaiterAcceptor<GetVariantStoreResult> {
        private static final JsonNode expectedResult;
