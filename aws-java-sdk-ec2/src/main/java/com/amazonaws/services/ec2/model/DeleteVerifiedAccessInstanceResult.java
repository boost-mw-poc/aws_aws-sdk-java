...
public class DeleteVerifiedAccessInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public DeleteVerifiedAccessInstanceResult withVerifiedAccessInstance(VerifiedAccessInstance verifiedAccessInstance) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVerifiedAccessInstanceResult == false)
            return false;
        DeleteVerifiedAccessInstanceResult other = (DeleteVerifiedAccessInstanceResult) obj;
    ...
    @Override
    public DeleteVerifiedAccessInstanceResult clone() {
        try {
            return (DeleteVerifiedAccessInstanceResult) super.clone();
