...
import com.amazonaws.services.ec2.model.transform.DetachVerifiedAccessTrustProviderRequestMarshaller;

/**
 * 
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DetachVerifiedAccessTrustProviderRequest extends AmazonWebServiceRequest implements Serializable, Cloneable,
        DryRunSupportedRequest<DetachVerifiedAccessTrustProviderRequest> {
     ...
     */
    @Override
    public Request<DetachVerifiedAccessTrustProviderRequest> getDryRunRequest() {
        Request<DetachVerifiedAccessTrustProviderRequest> request = new DetachVerifiedAccessTrustProviderRequestMarshaller().marshall(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DetachVerifiedAccessTrustProviderRequest == false)
            return false;
        DetachVerifiedAccessTrustProviderRequest other = (DetachVerifiedAccessTrustProviderRequest) obj;
    ...
    @Override
    public DetachVerifiedAccessTrustProviderRequest clone() {
        return (DetachVerifiedAccessTrustProviderRequest) super.clone();
    }
}
