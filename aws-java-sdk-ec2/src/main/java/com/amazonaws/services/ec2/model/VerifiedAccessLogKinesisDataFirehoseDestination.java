 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/VerifiedAccessLogKinesisDataFirehoseDestination"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class VerifiedAccessLogKinesisDataFirehoseDestination implements Serializable, Cloneable {
    ...
    public VerifiedAccessLogKinesisDataFirehoseDestination withEnabled(Boolean enabled) {
        setEnabled(enabled);
        return this;
    }
    ...
    public VerifiedAccessLogKinesisDataFirehoseDestination withDeliveryStatus(VerifiedAccessLogDeliveryStatus deliveryStatus) {
    ...
    public VerifiedAccessLogKinesisDataFirehoseDestination withDeliveryStream(String deliveryStream) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VerifiedAccessLogKinesisDataFirehoseDestination == false)
            return false;
    ...
    @Override
    public VerifiedAccessLogKinesisDataFirehoseDestination clone() {
        try {
            return (VerifiedAccessLogKinesisDataFirehoseDestination) super.clone();
