...
public class DeleteVerifiedAccessTrustProviderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public DeleteVerifiedAccessTrustProviderResult withVerifiedAccessTrustProvider(VerifiedAccessTrustProvider verifiedAccessTrustProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteVerifiedAccessTrustProviderResult == false)
            return false;
        DeleteVerifiedAccessTrustProviderResult other = (DeleteVerifiedAccessTrustProviderResult) obj;
    ...
    @Override
    public DeleteVerifiedAccessTrustProviderResult clone() {
        try {
            return (DeleteVerifiedAccessTrustProviderResult) super.clone();
