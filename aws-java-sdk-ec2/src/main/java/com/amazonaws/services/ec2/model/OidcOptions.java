...
public class OidcOptions implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The OpenID Connect (OIDC) scope specified.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OidcOptions == false)
            return false;
        OidcOptions other = (OidcOptions) obj;
    ...
    public OidcOptions clone() {
        try {
            return (OidcOptions) super.clone();
