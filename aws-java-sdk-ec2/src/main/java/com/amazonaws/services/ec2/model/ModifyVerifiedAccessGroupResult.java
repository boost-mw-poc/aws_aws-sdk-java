...
public class ModifyVerifiedAccessGroupResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return Details of Amazon Web Services Verified Access group.
     */
    ...
    public ModifyVerifiedAccessGroupResult withVerifiedAccessGroup(VerifiedAccessGroup verifiedAccessGroup) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVerifiedAccessGroupResult == false)
            return false;
        ModifyVerifiedAccessGroupResult other = (ModifyVerifiedAccessGroupResult) obj;
    ...
    @Override
    public ModifyVerifiedAccessGroupResult clone() {
        try {
            return (ModifyVerifiedAccessGroupResult) super.clone();
