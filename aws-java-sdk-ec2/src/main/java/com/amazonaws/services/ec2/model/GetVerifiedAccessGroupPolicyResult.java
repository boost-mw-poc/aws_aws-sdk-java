...
public class GetVerifiedAccessGroupPolicyResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetVerifiedAccessGroupPolicyResult == false)
            return false;
        GetVerifiedAccessGroupPolicyResult other = (GetVerifiedAccessGroupPolicyResult) obj;
    ...
    public GetVerifiedAccessGroupPolicyResult clone() {
        try {
            return (GetVerifiedAccessGroupPolicyResult) super.clone();
