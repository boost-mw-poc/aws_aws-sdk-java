...
public class CreateVerifiedAccessEndpointResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateVerifiedAccessEndpointResult withVerifiedAccessEndpoint(VerifiedAccessEndpoint verifiedAccessEndpoint) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateVerifiedAccessEndpointResult == false)
            return false;
        CreateVerifiedAccessEndpointResult other = (CreateVerifiedAccessEndpointResult) obj;
    ...
    @Override
    public CreateVerifiedAccessEndpointResult clone() {
        try {
            return (CreateVerifiedAccessEndpointResult) super.clone();
