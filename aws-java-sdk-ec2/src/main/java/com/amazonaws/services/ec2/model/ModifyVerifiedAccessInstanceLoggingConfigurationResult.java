...
public class ModifyVerifiedAccessInstanceLoggingConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public ModifyVerifiedAccessInstanceLoggingConfigurationResult withLoggingConfiguration(VerifiedAccessInstanceLoggingConfiguration loggingConfiguration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ModifyVerifiedAccessInstanceLoggingConfigurationResult == false)
            return false;
        ModifyVerifiedAccessInstanceLoggingConfigurationResult other = (ModifyVerifiedAccessInstanceLoggingConfigurationResult) obj;
    ...
    @Override
    public ModifyVerifiedAccessInstanceLoggingConfigurationResult clone() {
        try {
            return (ModifyVerifiedAccessInstanceLoggingConfigurationResult) super.clone();
