 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsWafRegionalRuleGroupRulesActionDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsWafRegionalRuleGroupRulesActionDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsWafRegionalRuleGroupRulesActionDetails == false)
            return false;
        AwsWafRegionalRuleGroupRulesActionDetails other = (AwsWafRegionalRuleGroupRulesActionDetails) obj;
    ...
    public AwsWafRegionalRuleGroupRulesActionDetails clone() {
        try {
            return (AwsWafRegionalRuleGroupRulesActionDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsWafRegionalRuleGroupRulesActionDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
