 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2ClientVpnEndpointConnectionLogOptionsDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEc2ClientVpnEndpointConnectionLogOptionsDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEc2ClientVpnEndpointConnectionLogOptionsDetails == false)
            return false;
        AwsEc2ClientVpnEndpointConnectionLogOptionsDetails other = (AwsEc2ClientVpnEndpointConnectionLogOptionsDetails) obj;
    ...
    public AwsEc2ClientVpnEndpointConnectionLogOptionsDetails clone() {
        try {
            return (AwsEc2ClientVpnEndpointConnectionLogOptionsDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEc2ClientVpnEndpointConnectionLogOptionsDetailsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
