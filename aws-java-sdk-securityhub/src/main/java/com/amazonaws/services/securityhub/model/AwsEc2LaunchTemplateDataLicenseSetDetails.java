 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2LaunchTemplateDataLicenseSetDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEc2LaunchTemplateDataLicenseSetDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEc2LaunchTemplateDataLicenseSetDetails == false)
            return false;
        AwsEc2LaunchTemplateDataLicenseSetDetails other = (AwsEc2LaunchTemplateDataLicenseSetDetails) obj;
    ...
    public AwsEc2LaunchTemplateDataLicenseSetDetails clone() {
        try {
            return (AwsEc2LaunchTemplateDataLicenseSetDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEc2LaunchTemplateDataLicenseSetDetailsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
