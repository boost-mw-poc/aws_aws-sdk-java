        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Integer", targetDepth)) {
                    context.nextToken();
                    parameterValue.setInteger(context.getUnmarshaller(Integer.class).unmarshall(context));
                }
                if (context.testExpression("IntegerList", targetDepth)) {
                    context.nextToken();
                    parameterValue.setIntegerList(new ListUnmarshaller<Integer>(context.getUnmarshaller(Integer.class))

                    .unmarshall(context));
                }
                if (context.testExpression("Double", targetDepth)) {
                    context.nextToken();
                    parameterValue.setDouble(context.getUnmarshaller(Double.class).unmarshall(context));
                }
                if (context.testExpression("String", targetDepth)) {
                    context.nextToken();
                    parameterValue.setString(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("StringList", targetDepth)) {
                    context.nextToken();
                    parameterValue.setStringList(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))

                    .unmarshall(context));
                }
                if (context.testExpression("Boolean", targetDepth)) {
                    context.nextToken();
                    parameterValue.setBoolean(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
                if (context.testExpression("Enum", targetDepth)) {
                    context.nextToken();
                    parameterValue.setEnum(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("EnumList", targetDepth)) {
                    context.nextToken();
                    parameterValue.setEnumList(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
