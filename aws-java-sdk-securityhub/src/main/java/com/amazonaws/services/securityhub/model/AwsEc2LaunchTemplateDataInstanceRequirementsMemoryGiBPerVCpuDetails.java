 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/securityhub-2018-10-26/AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails == false)
            return false;
    ...
    @Override
    public AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails clone() {
        try {
            return (AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securityhub.model.transform.AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetailsMarshaller.getInstance()
