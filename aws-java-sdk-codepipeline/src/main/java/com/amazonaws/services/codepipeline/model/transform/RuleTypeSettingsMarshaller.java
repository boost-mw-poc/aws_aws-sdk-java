...
/**
 * RuleTypeSettingsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RuleTypeSettingsMarshaller {
    ...
    private static final RuleTypeSettingsMarshaller instance = new RuleTypeSettingsMarshaller();

    public static RuleTypeSettingsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RuleTypeSettings ruleTypeSettings, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(ruleTypeSettings.getThirdPartyConfigurationUrl(), THIRDPARTYCONFIGURATIONURL_BINDING);
            protocolMarshaller.marshall(ruleTypeSettings.getEntityUrlTemplate(), ENTITYURLTEMPLATE_BINDING);
            protocolMarshaller.marshall(ruleTypeSettings.getExecutionUrlTemplate(), EXECUTIONURLTEMPLATE_BINDING);
            protocolMarshaller.marshall(ruleTypeSettings.getRevisionUrlTemplate(), REVISIONURLTEMPLATE_BINDING);
        } catch (Exception e) {
