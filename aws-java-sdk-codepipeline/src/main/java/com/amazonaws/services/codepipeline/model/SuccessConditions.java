 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codepipeline-2015-07-09/SuccessConditions" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SuccessConditions implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return The conditions that are success conditions.
     */
    ...
    public SuccessConditions withConditions(Condition... conditions) {
    ...
    public SuccessConditions withConditions(java.util.Collection<Condition> conditions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SuccessConditions == false)
            return false;
        SuccessConditions other = (SuccessConditions) obj;
    ...
    @Override
    public SuccessConditions clone() {
        try {
            return (SuccessConditions) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.codepipeline.model.transform.SuccessConditionsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
