 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/codepipeline-2015-07-09/RuleTypeSettings" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class RuleTypeSettings implements Serializable, Cloneable, StructuredPojo {
    ...
    public RuleTypeSettings withThirdPartyConfigurationUrl(String thirdPartyConfigurationUrl) {
    ...
    public RuleTypeSettings withEntityUrlTemplate(String entityUrlTemplate) {
    ...
    public RuleTypeSettings withExecutionUrlTemplate(String executionUrlTemplate) {
    ...
    public RuleTypeSettings withRevisionUrlTemplate(String revisionUrlTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof RuleTypeSettings == false)
            return false;
        RuleTypeSettings other = (RuleTypeSettings) obj;
    ...
    @Override
    public RuleTypeSettings clone() {
        try {
            return (RuleTypeSettings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.codepipeline.model.transform.RuleTypeSettingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
