...
/**
 * RuleExecutionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class RuleExecutionMarshaller {
    ...
    private static final RuleExecutionMarshaller instance = new RuleExecutionMarshaller();

    public static RuleExecutionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(RuleExecution ruleExecution, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(ruleExecution.getRuleExecutionId(), RULEEXECUTIONID_BINDING);
            protocolMarshaller.marshall(ruleExecution.getStatus(), STATUS_BINDING);
            protocolMarshaller.marshall(ruleExecution.getSummary(), SUMMARY_BINDING);
            protocolMarshaller.marshall(ruleExecution.getLastStatusChange(), LASTSTATUSCHANGE_BINDING);
            protocolMarshaller.marshall(ruleExecution.getToken(), TOKEN_BINDING);
            protocolMarshaller.marshall(ruleExecution.getLastUpdatedBy(), LASTUPDATEDBY_BINDING);
            protocolMarshaller.marshall(ruleExecution.getExternalExecutionId(), EXTERNALEXECUTIONID_BINDING);
            protocolMarshaller.marshall(ruleExecution.getExternalExecutionUrl(), EXTERNALEXECUTIONURL_BINDING);
            protocolMarshaller.marshall(ruleExecution.getErrorDetails(), ERRORDETAILS_BINDING);
        } catch (Exception e) {
