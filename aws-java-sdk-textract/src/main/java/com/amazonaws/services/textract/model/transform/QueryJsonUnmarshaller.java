        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Text", targetDepth)) {
                    context.nextToken();
                    query.setText(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Alias", targetDepth)) {
                    context.nextToken();
                    query.setAlias(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Pages", targetDepth)) {
                    context.nextToken();
                    query.setPages(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
