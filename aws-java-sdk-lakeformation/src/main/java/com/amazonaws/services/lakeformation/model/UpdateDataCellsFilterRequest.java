...
public class UpdateDataCellsFilterRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateDataCellsFilterRequest withTableData(DataCellsFilter tableData) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateDataCellsFilterRequest == false)
            return false;
        UpdateDataCellsFilterRequest other = (UpdateDataCellsFilterRequest) obj;
    ...
    @Override
    public UpdateDataCellsFilterRequest clone() {
        return (UpdateDataCellsFilterRequest) super.clone();
    }
