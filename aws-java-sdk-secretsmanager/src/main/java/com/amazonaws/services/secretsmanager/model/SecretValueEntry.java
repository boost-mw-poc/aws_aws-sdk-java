 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/secretsmanager-2017-10-17/SecretValueEntry" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class SecretValueEntry implements Serializable, Cloneable, StructuredPojo {
    ...
    public SecretValueEntry withSecretBinary(java.nio.ByteBuffer secretBinary) {
    ...
    public SecretValueEntry withVersionStages(String... versionStages) {
    ...
    public SecretValueEntry withVersionStages(java.util.Collection<String> versionStages) {
    ...
    public SecretValueEntry withCreatedDate(java.util.Date createdDate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecretValueEntry == false)
            return false;
    ...
    public SecretValueEntry clone() {
        try {
            return (SecretValueEntry) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.secretsmanager.model.transform.SecretValueEntryMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
