...
/**
 * MetricStat CBOR Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class MetricStatRpcV2CborUnmarshaller implements Unmarshaller<MetricStat, RpcV2CborUnmarshallerContext> {

    public MetricStat unmarshall(RpcV2CborUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Metric", targetDepth)) {
                    context.nextToken();
                    metricStat.setMetric(MetricRpcV2CborUnmarshaller.getInstance().unmarshall(context));
                }
    ...
    private static MetricStatRpcV2CborUnmarshaller instance;

    public static MetricStatRpcV2CborUnmarshaller getInstance() {
        if (instance == null)
            instance = new MetricStatRpcV2CborUnmarshaller();
        return instance;
    }
}
