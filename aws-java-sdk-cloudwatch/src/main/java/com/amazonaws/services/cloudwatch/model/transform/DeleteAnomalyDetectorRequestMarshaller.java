...
public class DeleteAnomalyDetectorRequestMarshaller {
    ...
    public void marshall(DeleteAnomalyDetectorRequest deleteAnomalyDetectorRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(deleteAnomalyDetectorRequest.getNamespace(), NAMESPACE_BINDING);
            protocolMarshaller.marshall(deleteAnomalyDetectorRequest.getMetricName(), METRICNAME_BINDING);
            if (deleteAnomalyDetectorRequest.getDimensions() != null && !deleteAnomalyDetectorRequest.getDimensions().isEmpty()) {
                protocolMarshaller.marshall(deleteAnomalyDetectorRequest.getDimensions(), DIMENSIONS_BINDING);
            }
            protocolMarshaller.marshall(deleteAnomalyDetectorRequest.getStat(), STAT_BINDING);
            protocolMarshaller.marshall(deleteAnomalyDetectorRequest.getSingleMetricAnomalyDetector(), SINGLEMETRICANOMALYDETECTOR_BINDING);
            protocolMarshaller.marshall(deleteAnomalyDetectorRequest.getMetricMathAnomalyDetector(), METRICMATHANOMALYDETECTOR_BINDING);
        } catch (Exception e) {
