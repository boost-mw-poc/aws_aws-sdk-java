...
/**
 * AnomalyDetectorConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AnomalyDetectorConfigurationMarshaller {

    private static final MarshallingInfo<List> EXCLUDEDTIMERANGES_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("ExcludedTimeRanges").build();
    private static final MarshallingInfo<String> METRICTIMEZONE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("MetricTimezone").build();
    ...
    public void marshall(AnomalyDetectorConfiguration anomalyDetectorConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(anomalyDetectorConfiguration.getMetricTimezone(), METRICTIMEZONE_BINDING);
        } catch (Exception e) {
