...
public class ManagedRule implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cloudwatch.model.transform.ManagedRuleMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
