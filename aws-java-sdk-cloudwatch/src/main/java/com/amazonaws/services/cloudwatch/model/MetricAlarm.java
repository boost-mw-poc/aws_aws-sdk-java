...
public class MetricAlarm implements Serializable, Cloneable, StructuredPojo {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cloudwatch.model.transform.MetricAlarmMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
