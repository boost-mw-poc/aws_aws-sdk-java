...
public class ManagedRuleMarshaller {
    ...
    public void marshall(ManagedRule managedRule, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(managedRule.getTemplateName(), TEMPLATENAME_BINDING);
            protocolMarshaller.marshall(managedRule.getResourceARN(), RESOURCEARN_BINDING);
