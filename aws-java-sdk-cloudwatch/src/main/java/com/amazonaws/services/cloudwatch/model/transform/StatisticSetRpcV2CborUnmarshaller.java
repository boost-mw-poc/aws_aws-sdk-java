...
/**
 * StatisticSet CBOR Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StatisticSetRpcV2CborUnmarshaller implements Unmarshaller<StatisticSet, RpcV2CborUnmarshallerContext> {

    public StatisticSet unmarshall(RpcV2CborUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("SampleCount", targetDepth)) {
                    context.nextToken();
                    statisticSet.setSampleCount(context.getUnmarshaller(Double.class).unmarshall(context));
                }
    ...
    private static StatisticSetRpcV2CborUnmarshaller instance;

    public static StatisticSetRpcV2CborUnmarshaller getInstance() {
        if (instance == null)
            instance = new StatisticSetRpcV2CborUnmarshaller();
        return instance;
    }
}
