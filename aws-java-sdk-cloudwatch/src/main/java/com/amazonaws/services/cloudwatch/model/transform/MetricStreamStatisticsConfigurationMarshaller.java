...
/**
 * MetricStreamStatisticsConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class MetricStreamStatisticsConfigurationMarshaller {

    private static final MarshallingInfo<List> INCLUDEMETRICS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IncludeMetrics").build();
    private static final MarshallingInfo<List> ADDITIONALSTATISTICS_BINDING = MarshallingInfo.builder(MarshallingType.LIST)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AdditionalStatistics").build();
    ...
    public void marshall(MetricStreamStatisticsConfiguration metricStreamStatisticsConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            if (metricStreamStatisticsConfiguration.getAdditionalStatistics() != null
                    && !metricStreamStatisticsConfiguration.getAdditionalStatistics().isEmpty()) {
