...
public class UpdateAutomatedDiscoveryConfigurationRequestMarshaller {
    ...
    private static final UpdateAutomatedDiscoveryConfigurationRequestMarshaller instance = new UpdateAutomatedDiscoveryConfigurationRequestMarshaller();

    public static UpdateAutomatedDiscoveryConfigurationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateAutomatedDiscoveryConfigurationRequest updateAutomatedDiscoveryConfigurationRequest, ProtocolMarshaller protocolMarshaller) {
