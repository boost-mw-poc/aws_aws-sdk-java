...
/**
 * GetAutomatedDiscoveryConfigurationResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetAutomatedDiscoveryConfigurationResultJsonUnmarshaller implements
        Unmarshaller<GetAutomatedDiscoveryConfigurationResult, JsonUnmarshallerContext> {

    public GetAutomatedDiscoveryConfigurationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetAutomatedDiscoveryConfigurationResult getAutomatedDiscoveryConfigurationResult = new GetAutomatedDiscoveryConfigurationResult();
    ...
    private static GetAutomatedDiscoveryConfigurationResultJsonUnmarshaller instance;

    public static GetAutomatedDiscoveryConfigurationResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetAutomatedDiscoveryConfigurationResultJsonUnmarshaller();
        return instance;
    }
}
