...
/**
 * DeleteDatalakeDelegatedAdminResult JSON Unmarshaller
 */
...
public class DeleteDatalakeDelegatedAdminResultJsonUnmarshaller implements Unmarshaller<DeleteDatalakeDelegatedAdminResult, JsonUnmarshallerContext> {
    ...
    public DeleteDatalakeDelegatedAdminResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteDatalakeDelegatedAdminResult deleteDatalakeDelegatedAdminResult = new DeleteDatalakeDelegatedAdminResult();

        return deleteDatalakeDelegatedAdminResult;
    }
