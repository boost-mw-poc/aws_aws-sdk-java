...
public class LakeConfigurationResponse implements Serializable, Cloneable, StructuredPojo {
    ...
    /**
     * <p>
     * Amazon Resource Names (ARNs) uniquely identify Amazon Web Services resources. Security Lake requires an ARN when
     * you need to specify a resource unambiguously across all of Amazon Web Services, such as in IAM policies, Amazon
    ...
    public LakeConfigurationResponse withReplicationDestinationRegions(java.util.Collection<String> replicationDestinationRegions) {
    ...
    public LakeConfigurationResponse withRetentionSettings(java.util.Collection<RetentionSetting> retentionSettings) {
     ...
     * </p>
     * 
     * @return Amazon Resource Names (ARNs) uniquely identify Amazon Web Services resources. Security Lake requires an
     *         ARN when you need to specify a resource unambiguously across all of Amazon Web Services, such as in IAM
     *         policies, Amazon Relational Database Service (Amazon RDS) tags, and API calls.
     */
     ...
     *
     * @see LakeConfigurationResponse#withTagsMap
     * @returns a reference to this object so that method calls can be chained together.
     */

    public LakeConfigurationResponse addTagsMapEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LakeConfigurationResponse == false)
            return false;
    ...
    public LakeConfigurationResponse clone() {
        try {
            return (LakeConfigurationResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.securitylake.model.transform.LakeConfigurationResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
