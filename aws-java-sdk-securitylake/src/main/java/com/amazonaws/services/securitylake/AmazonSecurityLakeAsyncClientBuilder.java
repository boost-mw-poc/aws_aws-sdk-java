...
/**
 * Fluent builder for {@link com.amazonaws.services.securitylake.AmazonSecurityLakeAsync}. Use of the builder is
...
public final class AmazonSecurityLakeAsyncClientBuilder extends AwsAsyncClientBuilder<AmazonSecurityLakeAsyncClientBuilder, AmazonSecurityLakeAsync> {
    ...
    /**
     * Construct an asynchronous implementation of AmazonSecurityLakeAsync using the current builder configuration.
     *
     * @param params
     *        Current builder configuration represented as a parameter object.
     * @return Fully configured implementation of AmazonSecurityLakeAsync.
     */
    @Override
    protected AmazonSecurityLakeAsync build(AwsAsyncClientParams params) {
        return new AmazonSecurityLakeAsyncClient(params);
    }
