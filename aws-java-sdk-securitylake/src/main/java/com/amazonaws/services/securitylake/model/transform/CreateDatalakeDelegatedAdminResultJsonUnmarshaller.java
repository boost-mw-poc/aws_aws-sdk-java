...
/**
 * CreateDatalakeDelegatedAdminResult JSON Unmarshaller
 */
...
public class CreateDatalakeDelegatedAdminResultJsonUnmarshaller implements Unmarshaller<CreateDatalakeDelegatedAdminResult, JsonUnmarshallerContext> {
    ...
    public CreateDatalakeDelegatedAdminResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CreateDatalakeDelegatedAdminResult createDatalakeDelegatedAdminResult = new CreateDatalakeDelegatedAdminResult();

        return createDatalakeDelegatedAdminResult;
    }
