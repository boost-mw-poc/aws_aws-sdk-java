...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.securitylake.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.securitylake.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.securitylake.model.ValidationException validationException = new com.amazonaws.services.securitylake.model.ValidationException(
                null);
