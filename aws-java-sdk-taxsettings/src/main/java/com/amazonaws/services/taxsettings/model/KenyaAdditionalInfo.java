 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/taxsettings-2018-05-10/KenyaAdditionalInfo" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class KenyaAdditionalInfo implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof KenyaAdditionalInfo == false)
            return false;
    ...
    public KenyaAdditionalInfo clone() {
        try {
            return (KenyaAdditionalInfo) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.taxsettings.model.transform.KenyaAdditionalInfoMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
