...
/**
 * TaxRegistrationEntry JSON Unmarshaller
 */
...
public class TaxRegistrationEntryJsonUnmarshaller implements Unmarshaller<TaxRegistrationEntry, JsonUnmarshallerContext> {
    ...
    public TaxRegistrationEntry unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("additionalTaxInformation", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setAdditionalTaxInformation(AdditionalInfoRequestJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("certifiedEmailId", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setCertifiedEmailId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("legalAddress", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setLegalAddress(AddressJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("legalName", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setLegalName(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("registrationId", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setRegistrationId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("registrationType", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setRegistrationType(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("sector", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setSector(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("verificationDetails", targetDepth)) {
                    context.nextToken();
                    taxRegistrationEntry.setVerificationDetails(VerificationDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
