...
public class ValidationExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ValidationExceptionUnmarshaller() {
        super(com.amazonaws.services.taxsettings.model.ValidationException.class, "ValidationException");
    }

    @Override
    public com.amazonaws.services.taxsettings.model.ValidationException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.taxsettings.model.ValidationException validationException = new com.amazonaws.services.taxsettings.model.ValidationException(
                null);
