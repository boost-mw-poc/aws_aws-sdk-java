...
public class GetTaxRegistrationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetTaxRegistrationResult == false)
            return false;
        GetTaxRegistrationResult other = (GetTaxRegistrationResult) obj;
    ...
    public GetTaxRegistrationResult clone() {
        try {
            return (GetTaxRegistrationResult) super.clone();
