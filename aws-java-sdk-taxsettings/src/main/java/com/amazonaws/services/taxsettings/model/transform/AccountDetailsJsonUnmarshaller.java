        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("accountMetaData", targetDepth)) {
                    context.nextToken();
                    accountDetails.setAccountMetaData(AccountMetaDataJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("taxInheritanceDetails", targetDepth)) {
                    context.nextToken();
                    accountDetails.setTaxInheritanceDetails(TaxInheritanceDetailsJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("taxRegistration", targetDepth)) {
                    context.nextToken();
                    accountDetails.setTaxRegistration(TaxRegistrationWithJurisdictionJsonUnmarshaller.getInstance().unmarshall(context));
                }
