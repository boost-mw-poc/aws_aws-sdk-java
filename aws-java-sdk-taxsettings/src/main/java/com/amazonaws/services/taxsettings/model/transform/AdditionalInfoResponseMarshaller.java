...
public class AdditionalInfoResponseMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> BRAZILADDITIONALINFO_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    private static final MarshallingInfo<StructuredPojo> INDIAADDITIONALINFO_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
