 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/taxsettings-2018-05-10/BatchDeleteTaxRegistrationError"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class BatchDeleteTaxRegistrationError implements Serializable, Cloneable, StructuredPojo {
    ...
    public BatchDeleteTaxRegistrationError withAccountId(String accountId) {
    ...
    public BatchDeleteTaxRegistrationError withMessage(String message) {
        setMessage(message);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof BatchDeleteTaxRegistrationError == false)
            return false;
    ...
    public BatchDeleteTaxRegistrationError clone() {
        try {
            return (BatchDeleteTaxRegistrationError) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.taxsettings.model.transform.BatchDeleteTaxRegistrationErrorMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
