...
/**
 * DeleteTaxRegistrationResult JSON Unmarshaller
 */
...
public class DeleteTaxRegistrationResultJsonUnmarshaller implements Unmarshaller<DeleteTaxRegistrationResult, JsonUnmarshallerContext> {
    ...
    public DeleteTaxRegistrationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteTaxRegistrationResult deleteTaxRegistrationResult = new DeleteTaxRegistrationResult();
