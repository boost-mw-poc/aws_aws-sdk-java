...
/**
 * JurisdictionMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class JurisdictionMarshaller {
    ...
    private static final JurisdictionMarshaller instance = new JurisdictionMarshaller();

    public static JurisdictionMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Jurisdiction jurisdiction, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(jurisdiction.getCountryCode(), COUNTRYCODE_BINDING);
            protocolMarshaller.marshall(jurisdiction.getStateOrRegion(), STATEORREGION_BINDING);
        } catch (Exception e) {
