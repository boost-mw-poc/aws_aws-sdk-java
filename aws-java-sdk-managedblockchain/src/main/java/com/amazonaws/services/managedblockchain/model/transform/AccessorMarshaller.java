...
@SdkInternalApi
public class AccessorMarshaller {

    private static final MarshallingInfo<String> ID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Id").build();
    private static final MarshallingInfo<String> TYPE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("Type").build();
    private static final MarshallingInfo<String> BILLINGTOKEN_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("BillingToken").build();
    ...
    public static AccessorMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Accessor accessor, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accessor.getId(), ID_BINDING);
            protocolMarshaller.marshall(accessor.getType(), TYPE_BINDING);
            protocolMarshaller.marshall(accessor.getBillingToken(), BILLINGTOKEN_BINDING);
