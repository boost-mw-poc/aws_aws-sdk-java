...
/**
 * AccessorSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AccessorSummaryMarshaller {
    ...
    public static AccessorSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AccessorSummary accessorSummary, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(accessorSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(accessorSummary.getType(), TYPE_BINDING);
