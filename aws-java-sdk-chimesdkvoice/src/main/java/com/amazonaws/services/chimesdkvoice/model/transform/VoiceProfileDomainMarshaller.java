...
/**
 * VoiceProfileDomainMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VoiceProfileDomainMarshaller {
    ...
    private static final VoiceProfileDomainMarshaller instance = new VoiceProfileDomainMarshaller();

    public static VoiceProfileDomainMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VoiceProfileDomain voiceProfileDomain, ProtocolMarshaller protocolMarshaller) {

        if (voiceProfileDomain == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(voiceProfileDomain.getVoiceProfileDomainId(), VOICEPROFILEDOMAINID_BINDING);
            protocolMarshaller.marshall(voiceProfileDomain.getVoiceProfileDomainArn(), VOICEPROFILEDOMAINARN_BINDING);
            protocolMarshaller.marshall(voiceProfileDomain.getName(), NAME_BINDING);
            protocolMarshaller.marshall(voiceProfileDomain.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(voiceProfileDomain.getServerSideEncryptionConfiguration(), SERVERSIDEENCRYPTIONCONFIGURATION_BINDING);
            protocolMarshaller.marshall(voiceProfileDomain.getCreatedTimestamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(voiceProfileDomain.getUpdatedTimestamp(), UPDATEDTIMESTAMP_BINDING);
        } catch (Exception e) {
