...
public class ResourceLimitExceededExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ResourceLimitExceededExceptionUnmarshaller() {
        super(com.amazonaws.services.chimesdkvoice.model.ResourceLimitExceededException.class, "ResourceLimitExceededException");
    }

    @Override
    public com.amazonaws.services.chimesdkvoice.model.ResourceLimitExceededException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.chimesdkvoice.model.ResourceLimitExceededException resourceLimitExceededException = new com.amazonaws.services.chimesdkvoice.model.ResourceLimitExceededException(
                null);
