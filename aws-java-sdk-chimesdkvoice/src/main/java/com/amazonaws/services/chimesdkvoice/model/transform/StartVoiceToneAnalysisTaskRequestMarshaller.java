...
public class StartVoiceToneAnalysisTaskRequestMarshaller {
    ...
    public void marshall(StartVoiceToneAnalysisTaskRequest startVoiceToneAnalysisTaskRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(startVoiceToneAnalysisTaskRequest.getVoiceConnectorId(), VOICECONNECTORID_BINDING);
            protocolMarshaller.marshall(startVoiceToneAnalysisTaskRequest.getTransactionId(), TRANSACTIONID_BINDING);
