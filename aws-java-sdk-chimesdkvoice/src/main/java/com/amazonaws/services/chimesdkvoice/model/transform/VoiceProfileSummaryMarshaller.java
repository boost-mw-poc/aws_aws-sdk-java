...
/**
 * VoiceProfileSummaryMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class VoiceProfileSummaryMarshaller {
    ...
    private static final VoiceProfileSummaryMarshaller instance = new VoiceProfileSummaryMarshaller();

    public static VoiceProfileSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(VoiceProfileSummary voiceProfileSummary, ProtocolMarshaller protocolMarshaller) {

        if (voiceProfileSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(voiceProfileSummary.getVoiceProfileId(), VOICEPROFILEID_BINDING);
            protocolMarshaller.marshall(voiceProfileSummary.getVoiceProfileArn(), VOICEPROFILEARN_BINDING);
            protocolMarshaller.marshall(voiceProfileSummary.getVoiceProfileDomainId(), VOICEPROFILEDOMAINID_BINDING);
            protocolMarshaller.marshall(voiceProfileSummary.getCreatedTimestamp(), CREATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(voiceProfileSummary.getUpdatedTimestamp(), UPDATEDTIMESTAMP_BINDING);
            protocolMarshaller.marshall(voiceProfileSummary.getExpirationTimestamp(), EXPIRATIONTIMESTAMP_BINDING);
        } catch (Exception e) {
