...
/**
 * CallDetailsMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CallDetailsMarshaller {
    ...
    private static final MarshallingInfo<Boolean> ISCALLER_BINDING = MarshallingInfo.builder(MarshallingType.BOOLEAN)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("IsCaller").build();

    private static final CallDetailsMarshaller instance = new CallDetailsMarshaller();

    public static CallDetailsMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CallDetails callDetails, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(callDetails.getVoiceConnectorId(), VOICECONNECTORID_BINDING);
            protocolMarshaller.marshall(callDetails.getTransactionId(), TRANSACTIONID_BINDING);
            protocolMarshaller.marshall(callDetails.getIsCaller(), ISCALLER_BINDING);
        } catch (Exception e) {
