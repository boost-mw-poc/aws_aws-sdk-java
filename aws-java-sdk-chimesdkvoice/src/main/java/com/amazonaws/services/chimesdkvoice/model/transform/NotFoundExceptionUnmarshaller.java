...
public class NotFoundExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private NotFoundExceptionUnmarshaller() {
        super(com.amazonaws.services.chimesdkvoice.model.NotFoundException.class, "NotFoundException");
    }

    @Override
    public com.amazonaws.services.chimesdkvoice.model.NotFoundException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.chimesdkvoice.model.NotFoundException notFoundException = new com.amazonaws.services.chimesdkvoice.model.NotFoundException(null);
