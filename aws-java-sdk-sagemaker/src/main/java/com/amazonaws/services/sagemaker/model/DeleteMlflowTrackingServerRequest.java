...
public class DeleteMlflowTrackingServerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the the tracking server to delete.
     */
    ...
    public DeleteMlflowTrackingServerRequest withTrackingServerName(String trackingServerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteMlflowTrackingServerRequest == false)
            return false;
        DeleteMlflowTrackingServerRequest other = (DeleteMlflowTrackingServerRequest) obj;
    ...
    @Override
    public DeleteMlflowTrackingServerRequest clone() {
        return (DeleteMlflowTrackingServerRequest) super.clone();
    }
