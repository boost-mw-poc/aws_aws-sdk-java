...
public class CreateAutoMLJobV2Result extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique ARN assigned to the AutoMLJob when it is created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateAutoMLJobV2Result == false)
            return false;
        CreateAutoMLJobV2Result other = (CreateAutoMLJobV2Result) obj;
    ...
    public CreateAutoMLJobV2Result clone() {
        try {
            return (CreateAutoMLJobV2Result) super.clone();
