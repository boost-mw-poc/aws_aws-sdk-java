...
public class UpdateMlflowTrackingServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateMlflowTrackingServerResult withTrackingServerArn(String trackingServerArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateMlflowTrackingServerResult == false)
            return false;
        UpdateMlflowTrackingServerResult other = (UpdateMlflowTrackingServerResult) obj;
    ...
    @Override
    public UpdateMlflowTrackingServerResult clone() {
        try {
            return (UpdateMlflowTrackingServerResult) super.clone();
