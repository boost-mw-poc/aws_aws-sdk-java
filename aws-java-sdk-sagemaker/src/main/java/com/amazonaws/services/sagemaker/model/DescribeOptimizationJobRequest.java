...
public class DescribeOptimizationJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DescribeOptimizationJobRequest withOptimizationJobName(String optimizationJobName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeOptimizationJobRequest == false)
            return false;
        DescribeOptimizationJobRequest other = (DescribeOptimizationJobRequest) obj;
    ...
    @Override
    public DescribeOptimizationJobRequest clone() {
        return (DescribeOptimizationJobRequest) super.clone();
    }
