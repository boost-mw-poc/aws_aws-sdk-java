...
public class StartMlflowTrackingServerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public StartMlflowTrackingServerRequest withTrackingServerName(String trackingServerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartMlflowTrackingServerRequest == false)
            return false;
    ...
    @Override
    public StartMlflowTrackingServerRequest clone() {
        return (StartMlflowTrackingServerRequest) super.clone();
    }
