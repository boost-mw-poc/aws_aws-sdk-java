 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/AdditionalModelDataSource"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AdditionalModelDataSource implements Serializable, Cloneable, StructuredPojo {
    ...
    public AdditionalModelDataSource withChannelName(String channelName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdditionalModelDataSource == false)
            return false;
    ...
    public AdditionalModelDataSource clone() {
        try {
            return (AdditionalModelDataSource) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.sagemaker.model.transform.AdditionalModelDataSourceMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
