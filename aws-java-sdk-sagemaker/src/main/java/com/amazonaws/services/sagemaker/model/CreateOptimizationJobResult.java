...
public class CreateOptimizationJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CreateOptimizationJobResult withOptimizationJobArn(String optimizationJobArn) {
    ...
    public String toString() {
        ...
        if (getOptimizationJobArn() != null)
            sb.append("OptimizationJobArn: ").append(getOptimizationJobArn());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateOptimizationJobResult == false)
            return false;
        CreateOptimizationJobResult other = (CreateOptimizationJobResult) obj;
    ...
    @Override
    public CreateOptimizationJobResult clone() {
        try {
            return (CreateOptimizationJobResult) super.clone();
