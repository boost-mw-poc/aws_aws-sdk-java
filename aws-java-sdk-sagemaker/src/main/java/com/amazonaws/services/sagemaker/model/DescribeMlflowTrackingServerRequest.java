...
public class DescribeMlflowTrackingServerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the MLflow Tracking Server to describe.
     */
    ...
    public DescribeMlflowTrackingServerRequest withTrackingServerName(String trackingServerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DescribeMlflowTrackingServerRequest == false)
            return false;
        DescribeMlflowTrackingServerRequest other = (DescribeMlflowTrackingServerRequest) obj;
    ...
    @Override
    public DescribeMlflowTrackingServerRequest clone() {
        return (DescribeMlflowTrackingServerRequest) super.clone();
    }
