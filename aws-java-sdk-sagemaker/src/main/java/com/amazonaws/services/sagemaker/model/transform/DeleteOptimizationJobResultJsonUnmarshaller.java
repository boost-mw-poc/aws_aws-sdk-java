...
/**
 * DeleteOptimizationJobResult JSON Unmarshaller
 */
...
public class DeleteOptimizationJobResultJsonUnmarshaller implements Unmarshaller<DeleteOptimizationJobResult, JsonUnmarshallerContext> {
    ...
    public DeleteOptimizationJobResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteOptimizationJobResult deleteOptimizationJobResult = new DeleteOptimizationJobResult();

        return deleteOptimizationJobResult;
    }
