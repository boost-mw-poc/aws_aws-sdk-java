...
public class DomainSettingsForUpdateMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> AMAZONQSETTINGS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("AmazonQSettings").build();
    ...
    public void marshall(DomainSettingsForUpdate domainSettingsForUpdate, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(domainSettingsForUpdate.getAmazonQSettings(), AMAZONQSETTINGS_BINDING);
        } catch (Exception e) {
