...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopMlflowTrackingServer" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopMlflowTrackingServerRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The name of the tracking server to stop.
     */
    ...
    public StopMlflowTrackingServerRequest withTrackingServerName(String trackingServerName) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopMlflowTrackingServerRequest == false)
            return false;
        StopMlflowTrackingServerRequest other = (StopMlflowTrackingServerRequest) obj;
    ...
    @Override
    public StopMlflowTrackingServerRequest clone() {
        return (StopMlflowTrackingServerRequest) super.clone();
    }
