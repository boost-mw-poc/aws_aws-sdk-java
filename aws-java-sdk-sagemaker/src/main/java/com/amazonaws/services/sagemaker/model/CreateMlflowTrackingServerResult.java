...
public class CreateMlflowTrackingServerResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the tracking server.
     */
    ...
    public CreateMlflowTrackingServerResult withTrackingServerArn(String trackingServerArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateMlflowTrackingServerResult == false)
            return false;
        CreateMlflowTrackingServerResult other = (CreateMlflowTrackingServerResult) obj;
    ...
    @Override
    public CreateMlflowTrackingServerResult clone() {
        try {
