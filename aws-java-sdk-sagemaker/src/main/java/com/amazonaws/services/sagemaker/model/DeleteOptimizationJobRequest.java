...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteOptimizationJob" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class DeleteOptimizationJobRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public DeleteOptimizationJobRequest withOptimizationJobName(String optimizationJobName) {
    ...
    public String toString() {
        ...
        if (getOptimizationJobName() != null)
            sb.append("OptimizationJobName: ").append(getOptimizationJobName());
        sb.append("}");
        return sb.toString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteOptimizationJobRequest == false)
            return false;
        DeleteOptimizationJobRequest other = (DeleteOptimizationJobRequest) obj;
    ...
    @Override
    public DeleteOptimizationJobRequest clone() {
        return (DeleteOptimizationJobRequest) super.clone();
    }
