...
public class UpdateRepositoryCreationTemplateResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateRepositoryCreationTemplateResult withRegistryId(String registryId) {
    ...
    public UpdateRepositoryCreationTemplateResult withRepositoryCreationTemplate(RepositoryCreationTemplate repositoryCreationTemplate) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateRepositoryCreationTemplateResult == false)
            return false;
        UpdateRepositoryCreationTemplateResult other = (UpdateRepositoryCreationTemplateResult) obj;
    ...
    @Override
    public UpdateRepositoryCreationTemplateResult clone() {
        try {
            return (UpdateRepositoryCreationTemplateResult) super.clone();
