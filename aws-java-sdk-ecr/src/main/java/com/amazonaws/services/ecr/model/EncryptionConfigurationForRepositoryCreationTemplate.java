 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/ecr-2015-09-21/EncryptionConfigurationForRepositoryCreationTemplate"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class EncryptionConfigurationForRepositoryCreationTemplate implements Serializable, Cloneable, StructuredPojo {
    ...
    public EncryptionConfigurationForRepositoryCreationTemplate withEncryptionType(String encryptionType) {
    ...
    public EncryptionConfigurationForRepositoryCreationTemplate withEncryptionType(EncryptionType encryptionType) {
     ...
     * 
     * @param kmsKey
     *        If you use the <code>KMS</code> encryption type, specify the KMS key to use for encryption. The full ARN
    ...
    public EncryptionConfigurationForRepositoryCreationTemplate withKmsKey(String kmsKey) {
        setKmsKey(kmsKey);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EncryptionConfigurationForRepositoryCreationTemplate == false)
            return false;
    ...
    @Override
    public EncryptionConfigurationForRepositoryCreationTemplate clone() {
        try {
            return (EncryptionConfigurationForRepositoryCreationTemplate) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.ecr.model.transform.EncryptionConfigurationForRepositoryCreationTemplateMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
