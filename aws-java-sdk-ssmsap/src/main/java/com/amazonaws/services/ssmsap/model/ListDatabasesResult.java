...
public class ListDatabasesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setDatabases(java.util.Collection<DatabaseSummary> databases) {
        ...
        this.databases = new java.util.ArrayList<DatabaseSummary>(databases);
    }
    ...
    public ListDatabasesResult withDatabases(DatabaseSummary... databases) {
        if (this.databases == null) {
            setDatabases(new java.util.ArrayList<DatabaseSummary>(databases.length));
        }
        for (DatabaseSummary ele : databases) {
    ...
    public ListDatabasesResult withDatabases(java.util.Collection<DatabaseSummary> databases) {
