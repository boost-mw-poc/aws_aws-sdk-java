...
public class GetDatabaseRequestMarshaller {
    ...
    public void marshall(GetDatabaseRequest getDatabaseRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getDatabaseRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(getDatabaseRequest.getComponentId(), COMPONENTID_BINDING);
            protocolMarshaller.marshall(getDatabaseRequest.getDatabaseId(), DATABASEID_BINDING);
            protocolMarshaller.marshall(getDatabaseRequest.getDatabaseArn(), DATABASEARN_BINDING);
        } catch (Exception e) {
