...
public class ListDatabasesRequestMarshaller {
    ...
    public void marshall(ListDatabasesRequest listDatabasesRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(listDatabasesRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(listDatabasesRequest.getComponentId(), COMPONENTID_BINDING);
