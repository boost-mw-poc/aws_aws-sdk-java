...
public class GetComponentRequestMarshaller {
    ...
    public void marshall(GetComponentRequest getComponentRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getComponentRequest.getApplicationId(), APPLICATIONID_BINDING);
            protocolMarshaller.marshall(getComponentRequest.getComponentId(), COMPONENTID_BINDING);
        } catch (Exception e) {
