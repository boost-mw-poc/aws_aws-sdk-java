        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Message", targetDepth)) {
                    context.nextToken();
                    updateApplicationSettingsResult.setMessage(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("OperationIds", targetDepth)) {
                    context.nextToken();
                    updateApplicationSettingsResult.setOperationIds(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
