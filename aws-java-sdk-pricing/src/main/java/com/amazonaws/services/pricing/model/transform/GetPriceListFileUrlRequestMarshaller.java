...
public class GetPriceListFileUrlRequestMarshaller {
    ...
    private static final GetPriceListFileUrlRequestMarshaller instance = new GetPriceListFileUrlRequestMarshaller();

    public static GetPriceListFileUrlRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetPriceListFileUrlRequest getPriceListFileUrlRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getPriceListFileUrlRequest.getPriceListArn(), PRICELISTARN_BINDING);
            protocolMarshaller.marshall(getPriceListFileUrlRequest.getFileFormat(), FILEFORMAT_BINDING);
        } catch (Exception e) {
