...
public class UpdateConfiguredTableAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public UpdateConfiguredTableAssociationResult withConfiguredTableAssociation(ConfiguredTableAssociation configuredTableAssociation) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfiguredTableAssociationResult == false)
            return false;
        UpdateConfiguredTableAssociationResult other = (UpdateConfiguredTableAssociationResult) obj;
    ...
    @Override
    public UpdateConfiguredTableAssociationResult clone() {
        try {
            return (UpdateConfiguredTableAssociationResult) super.clone();
