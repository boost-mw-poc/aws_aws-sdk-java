...
public class DeleteConfiguredTableRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique ID for the configured table to delete.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteConfiguredTableRequest == false)
            return false;
        DeleteConfiguredTableRequest other = (DeleteConfiguredTableRequest) obj;
    ...
    @Override
    public DeleteConfiguredTableRequest clone() {
        return (DeleteConfiguredTableRequest) super.clone();
    }
