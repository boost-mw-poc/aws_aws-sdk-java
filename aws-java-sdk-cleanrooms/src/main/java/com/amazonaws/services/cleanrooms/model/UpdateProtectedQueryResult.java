...
public class UpdateProtectedQueryResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The protected query output.
     */
    ...
    public UpdateProtectedQueryResult withProtectedQuery(ProtectedQuery protectedQuery) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateProtectedQueryResult == false)
            return false;
        UpdateProtectedQueryResult other = (UpdateProtectedQueryResult) obj;
    ...
    @Override
    public UpdateProtectedQueryResult clone() {
        try {
            return (UpdateProtectedQueryResult) super.clone();
