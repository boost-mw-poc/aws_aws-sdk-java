...
public class GetConfiguredTableAnalysisRuleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The analysis rule to be retrieved. Configured table analysis rules are uniquely identified by their configured
     ...
     * </p>
     * 
     * @return The unique identifier for the configured table to retrieve. Currently accepts the configured table ID.
     */
     ...
     * </p>
     * 
     * @return The analysis rule to be retrieved. Configured table analysis rules are uniquely identified by their
     *         configured table identifier and analysis rule type.
     * @see ConfiguredTableAnalysisRuleType
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConfiguredTableAnalysisRuleRequest == false)
            return false;
        GetConfiguredTableAnalysisRuleRequest other = (GetConfiguredTableAnalysisRuleRequest) obj;
    ...
    public GetConfiguredTableAnalysisRuleRequest clone() {
        return (GetConfiguredTableAnalysisRuleRequest) super.clone();
    }
