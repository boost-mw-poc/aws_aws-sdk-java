...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/GetIdMappingTable" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetIdMappingTableRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier of the ID mapping table identifier that you want to retrieve.
     */
     ...
     * </p>
     * 
     * @return The unique identifier of the membership that contains the ID mapping table that you want to retrieve.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIdMappingTableRequest == false)
            return false;
        GetIdMappingTableRequest other = (GetIdMappingTableRequest) obj;
    ...
    public GetIdMappingTableRequest clone() {
        return (GetIdMappingTableRequest) super.clone();
    }
