...
public class CreateIdMappingTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID mapping table that was created.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateIdMappingTableResult == false)
            return false;
        CreateIdMappingTableResult other = (CreateIdMappingTableResult) obj;
    ...
    public CreateIdMappingTableResult clone() {
        try {
            return (CreateIdMappingTableResult) super.clone();
