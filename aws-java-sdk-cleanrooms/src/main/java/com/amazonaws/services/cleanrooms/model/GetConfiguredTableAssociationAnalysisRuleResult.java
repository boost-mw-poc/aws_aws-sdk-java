...
public class GetConfiguredTableAssociationAnalysisRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
    ...
    public GetConfiguredTableAssociationAnalysisRuleResult withAnalysisRule(ConfiguredTableAssociationAnalysisRule analysisRule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConfiguredTableAssociationAnalysisRuleResult == false)
            return false;
        GetConfiguredTableAssociationAnalysisRuleResult other = (GetConfiguredTableAssociationAnalysisRuleResult) obj;
    ...
    public GetConfiguredTableAssociationAnalysisRuleResult clone() {
        try {
            return (GetConfiguredTableAssociationAnalysisRuleResult) super.clone();
