...
public class UpdateConfiguredTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The updated configured table.
     */
    ...
    public UpdateConfiguredTableResult withConfiguredTable(ConfiguredTable configuredTable) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfiguredTableResult == false)
            return false;
        UpdateConfiguredTableResult other = (UpdateConfiguredTableResult) obj;
    ...
    @Override
    public UpdateConfiguredTableResult clone() {
        try {
            return (UpdateConfiguredTableResult) super.clone();
