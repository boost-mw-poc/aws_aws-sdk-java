...
public class GetSchemaAnalysisRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetSchemaAnalysisRuleResult withAnalysisRule(AnalysisRule analysisRule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSchemaAnalysisRuleResult == false)
            return false;
        GetSchemaAnalysisRuleResult other = (GetSchemaAnalysisRuleResult) obj;
    ...
    @Override
    public GetSchemaAnalysisRuleResult clone() {
        try {
            return (GetSchemaAnalysisRuleResult) super.clone();
