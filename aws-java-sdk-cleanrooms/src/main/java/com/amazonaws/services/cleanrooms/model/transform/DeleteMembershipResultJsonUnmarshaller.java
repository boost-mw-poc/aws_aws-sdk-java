...
/**
 * DeleteMembershipResult JSON Unmarshaller
 */
...
public class DeleteMembershipResultJsonUnmarshaller implements Unmarshaller<DeleteMembershipResult, JsonUnmarshallerContext> {
    ...
    public DeleteMembershipResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteMembershipResult deleteMembershipResult = new DeleteMembershipResult();
