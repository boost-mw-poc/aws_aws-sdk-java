...
@SdkInternalApi
public class IdMappingTableSummaryMarshaller {
    ...
    private static final IdMappingTableSummaryMarshaller instance = new IdMappingTableSummaryMarshaller();

    public static IdMappingTableSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(IdMappingTableSummary idMappingTableSummary, ProtocolMarshaller protocolMarshaller) {

        if (idMappingTableSummary == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        try {
            protocolMarshaller.marshall(idMappingTableSummary.getCollaborationArn(), COLLABORATIONARN_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getCollaborationId(), COLLABORATIONID_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getMembershipId(), MEMBERSHIPID_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getMembershipArn(), MEMBERSHIPARN_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getCreateTime(), CREATETIME_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getUpdateTime(), UPDATETIME_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getId(), ID_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getInputReferenceConfig(), INPUTREFERENCECONFIG_BINDING);
            protocolMarshaller.marshall(idMappingTableSummary.getName(), NAME_BINDING);
        } catch (Exception e) {
