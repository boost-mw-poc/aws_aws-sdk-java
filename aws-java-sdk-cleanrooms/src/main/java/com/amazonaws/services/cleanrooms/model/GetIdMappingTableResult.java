...
public class GetIdMappingTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID mapping table that you requested.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetIdMappingTableResult == false)
            return false;
        GetIdMappingTableResult other = (GetIdMappingTableResult) obj;
    ...
    public GetIdMappingTableResult clone() {
        try {
            return (GetIdMappingTableResult) super.clone();
