...
public class GetConfiguredTableAssociationRequestMarshaller {
    ...
    private static final GetConfiguredTableAssociationRequestMarshaller instance = new GetConfiguredTableAssociationRequestMarshaller();

    public static GetConfiguredTableAssociationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetConfiguredTableAssociationRequest getConfiguredTableAssociationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(getConfiguredTableAssociationRequest.getConfiguredTableAssociationIdentifier(),
                    CONFIGUREDTABLEASSOCIATIONIDENTIFIER_BINDING);
            protocolMarshaller.marshall(getConfiguredTableAssociationRequest.getMembershipIdentifier(), MEMBERSHIPIDENTIFIER_BINDING);
        } catch (Exception e) {
