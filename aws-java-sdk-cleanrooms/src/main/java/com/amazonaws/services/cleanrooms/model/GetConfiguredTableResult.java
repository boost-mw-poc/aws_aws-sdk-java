...
public class GetConfiguredTableResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetConfiguredTableResult withConfiguredTable(ConfiguredTable configuredTable) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConfiguredTableResult == false)
            return false;
        GetConfiguredTableResult other = (GetConfiguredTableResult) obj;
    ...
    @Override
    public GetConfiguredTableResult clone() {
        try {
            return (GetConfiguredTableResult) super.clone();
