...
public class UpdateConfiguredTableAssociationAnalysisRuleRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public UpdateConfiguredTableAssociationAnalysisRuleRequest withAnalysisRuleType(String analysisRuleType) {
    ...
    public UpdateConfiguredTableAssociationAnalysisRuleRequest withAnalysisRuleType(ConfiguredTableAssociationAnalysisRuleType analysisRuleType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfiguredTableAssociationAnalysisRuleRequest == false)
            return false;
    ...
    @Override
    public UpdateConfiguredTableAssociationAnalysisRuleRequest clone() {
