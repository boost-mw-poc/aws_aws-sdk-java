 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/ConfiguredTableAssociationAnalysisRuleCustom"
...
public class ConfiguredTableAssociationAnalysisRuleCustom implements Serializable, Cloneable, StructuredPojo {
    ...
    public ConfiguredTableAssociationAnalysisRuleCustom withAllowedResultReceivers(java.util.Collection<String> allowedResultReceivers) {
    ...
    public ConfiguredTableAssociationAnalysisRuleCustom withAllowedAdditionalAnalyses(java.util.Collection<String> allowedAdditionalAnalyses) {
