...
public class GetConfiguredTableAnalysisRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
     ...
     * </p>
     * 
     * @return The entire analysis rule output.
     */
    ...
    public GetConfiguredTableAnalysisRuleResult withAnalysisRule(ConfiguredTableAnalysisRule analysisRule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConfiguredTableAnalysisRuleResult == false)
            return false;
        GetConfiguredTableAnalysisRuleResult other = (GetConfiguredTableAnalysisRuleResult) obj;
    ...
    @Override
    public GetConfiguredTableAnalysisRuleResult clone() {
        try {
            return (GetConfiguredTableAnalysisRuleResult) super.clone();
