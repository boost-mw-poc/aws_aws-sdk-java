 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/ConfiguredTableAssociationAnalysisRuleAggregation"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ConfiguredTableAssociationAnalysisRuleAggregation implements Serializable, Cloneable, StructuredPojo {
    ...
    public ConfiguredTableAssociationAnalysisRuleAggregation withAllowedResultReceivers(String... allowedResultReceivers) {
    ...
    public ConfiguredTableAssociationAnalysisRuleAggregation withAllowedResultReceivers(java.util.Collection<String> allowedResultReceivers) {
    ...
    public ConfiguredTableAssociationAnalysisRuleAggregation withAllowedAdditionalAnalyses(String... allowedAdditionalAnalyses) {
    ...
    public ConfiguredTableAssociationAnalysisRuleAggregation withAllowedAdditionalAnalyses(java.util.Collection<String> allowedAdditionalAnalyses) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ConfiguredTableAssociationAnalysisRuleAggregation == false)
            return false;
    ...
    @Override
    public ConfiguredTableAssociationAnalysisRuleAggregation clone() {
        try {
            return (ConfiguredTableAssociationAnalysisRuleAggregation) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.ConfiguredTableAssociationAnalysisRuleAggregationMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
