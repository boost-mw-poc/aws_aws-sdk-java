...
/**
 * DeleteIdNamespaceAssociationResult JSON Unmarshaller
 */
...
public class DeleteIdNamespaceAssociationResultJsonUnmarshaller implements Unmarshaller<DeleteIdNamespaceAssociationResult, JsonUnmarshallerContext> {
    ...
    public DeleteIdNamespaceAssociationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteIdNamespaceAssociationResult deleteIdNamespaceAssociationResult = new DeleteIdNamespaceAssociationResult();

        return deleteIdNamespaceAssociationResult;
    }
