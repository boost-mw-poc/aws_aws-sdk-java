...
/**
 * DeleteConfiguredTableResult JSON Unmarshaller
 */
...
public class DeleteConfiguredTableResultJsonUnmarshaller implements Unmarshaller<DeleteConfiguredTableResult, JsonUnmarshallerContext> {
    ...
    public DeleteConfiguredTableResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteConfiguredTableResult deleteConfiguredTableResult = new DeleteConfiguredTableResult();
