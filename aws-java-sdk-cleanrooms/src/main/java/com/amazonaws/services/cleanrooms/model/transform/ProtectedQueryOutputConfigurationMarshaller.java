...
/**
 * ProtectedQueryOutputConfigurationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ProtectedQueryOutputConfigurationMarshaller {
    ...
    public static ProtectedQueryOutputConfigurationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ProtectedQueryOutputConfiguration protectedQueryOutputConfiguration, ProtocolMarshaller protocolMarshaller) {

        if (protectedQueryOutputConfiguration == null) {
