...
public class UpdateConfiguredTableAssociationAnalysisRuleResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements
     ...
     * </p>
     * 
     * @return The updated analysis rule for the conﬁgured table association. In the console, the
     *         <code>ConfiguredTableAssociationAnalysisRule</code> is referred to as the <i>collaboration analysis
     *         rule</i>.
     */
    ...
    public UpdateConfiguredTableAssociationAnalysisRuleResult withAnalysisRule(ConfiguredTableAssociationAnalysisRule analysisRule) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateConfiguredTableAssociationAnalysisRuleResult == false)
            return false;
        UpdateConfiguredTableAssociationAnalysisRuleResult other = (UpdateConfiguredTableAssociationAnalysisRuleResult) obj;
    ...
    public UpdateConfiguredTableAssociationAnalysisRuleResult clone() {
        try {
            return (UpdateConfiguredTableAssociationAnalysisRuleResult) super.clone();
