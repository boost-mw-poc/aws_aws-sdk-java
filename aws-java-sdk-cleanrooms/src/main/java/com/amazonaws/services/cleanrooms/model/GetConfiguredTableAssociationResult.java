...
public class GetConfiguredTableAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetConfiguredTableAssociationResult == false)
            return false;
        GetConfiguredTableAssociationResult other = (GetConfiguredTableAssociationResult) obj;
    ...
    public GetConfiguredTableAssociationResult clone() {
        try {
            return (GetConfiguredTableAssociationResult) super.clone();
