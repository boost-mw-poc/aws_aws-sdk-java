...
public class ConfiguredTableMarshaller {
    ...
    public void marshall(ConfiguredTable configuredTable, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(configuredTable.getId(), ID_BINDING);
            protocolMarshaller.marshall(configuredTable.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(configuredTable.getName(), NAME_BINDING);
            protocolMarshaller.marshall(configuredTable.getDescription(), DESCRIPTION_BINDING);
            protocolMarshaller.marshall(configuredTable.getTableReference(), TABLEREFERENCE_BINDING);
            protocolMarshaller.marshall(configuredTable.getCreateTime(), CREATETIME_BINDING);
            protocolMarshaller.marshall(configuredTable.getUpdateTime(), UPDATETIME_BINDING);
            protocolMarshaller.marshall(configuredTable.getAnalysisRuleTypes(), ANALYSISRULETYPES_BINDING);
            protocolMarshaller.marshall(configuredTable.getAnalysisMethod(), ANALYSISMETHOD_BINDING);
