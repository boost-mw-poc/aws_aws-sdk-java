 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/cleanrooms-2022-02-17/IdMappingTableSchemaTypeProperties"
...
public class IdMappingTableSchemaTypeProperties implements Serializable, Cloneable, StructuredPojo {
    ...
    public IdMappingTableSchemaTypeProperties withIdMappingTableInputSource(IdMappingTableInputSource... idMappingTableInputSource) {
    ...
    public IdMappingTableSchemaTypeProperties withIdMappingTableInputSource(java.util.Collection<IdMappingTableInputSource> idMappingTableInputSource) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof IdMappingTableSchemaTypeProperties == false)
            return false;
    ...
    @Override
    public IdMappingTableSchemaTypeProperties clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.cleanrooms.model.transform.IdMappingTableSchemaTypePropertiesMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
