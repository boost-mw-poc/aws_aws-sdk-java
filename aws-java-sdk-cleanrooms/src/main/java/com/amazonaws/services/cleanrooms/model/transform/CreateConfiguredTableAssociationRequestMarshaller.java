...
/**
 * CreateConfiguredTableAssociationRequestMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class CreateConfiguredTableAssociationRequestMarshaller {
    ...
    public static CreateConfiguredTableAssociationRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(CreateConfiguredTableAssociationRequest createConfiguredTableAssociationRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(createConfiguredTableAssociationRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(createConfiguredTableAssociationRequest.getDescription(), DESCRIPTION_BINDING);
