...
public class ListIdMappingTablesRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The unique identifier of the membership that contains the ID mapping tables that you want to view.
     */
    ...
    public ListIdMappingTablesRequest withMembershipIdentifier(String membershipIdentifier) {
    ...
    public ListIdMappingTablesRequest withNextToken(String nextToken) {
    ...
    public ListIdMappingTablesRequest withMaxResults(Integer maxResults) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListIdMappingTablesRequest == false)
            return false;
        ListIdMappingTablesRequest other = (ListIdMappingTablesRequest) obj;
    ...
    @Override
    public ListIdMappingTablesRequest clone() {
        return (ListIdMappingTablesRequest) super.clone();
    }
