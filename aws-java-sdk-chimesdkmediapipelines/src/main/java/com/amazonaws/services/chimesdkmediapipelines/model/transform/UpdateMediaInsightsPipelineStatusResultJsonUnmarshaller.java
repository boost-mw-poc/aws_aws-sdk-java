...
/**
 * UpdateMediaInsightsPipelineStatusResult JSON Unmarshaller
 */
...
public class UpdateMediaInsightsPipelineStatusResultJsonUnmarshaller implements Unmarshaller<UpdateMediaInsightsPipelineStatusResult, JsonUnmarshallerContext> {
    ...
    public UpdateMediaInsightsPipelineStatusResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateMediaInsightsPipelineStatusResult updateMediaInsightsPipelineStatusResult = new UpdateMediaInsightsPipelineStatusResult();

        return updateMediaInsightsPipelineStatusResult;
    }
