...
@SdkInternalApi
public class LatencyMarshaller {
    ...
    private static final LatencyMarshaller instance = new LatencyMarshaller();

    public static LatencyMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Latency latency, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(latency.getRead(), READ_BINDING);
            protocolMarshaller.marshall(latency.getWrite(), WRITE_BINDING);
            protocolMarshaller.marshall(latency.getOther(), OTHER_BINDING);
        } catch (Exception e) {
