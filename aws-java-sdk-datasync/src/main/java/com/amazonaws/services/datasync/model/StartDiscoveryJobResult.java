...
public class StartDiscoveryJobResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the discovery job that you started.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartDiscoveryJobResult == false)
            return false;
        StartDiscoveryJobResult other = (StartDiscoveryJobResult) obj;
    ...
    public StartDiscoveryJobResult clone() {
        try {
            return (StartDiscoveryJobResult) super.clone();
