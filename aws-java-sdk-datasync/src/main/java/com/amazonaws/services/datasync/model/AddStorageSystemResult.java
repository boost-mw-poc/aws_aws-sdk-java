...
public class AddStorageSystemResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the on-premises storage system that you can use with DataSync Discovery.
     */
    ...
    public AddStorageSystemResult withStorageSystemArn(String storageSystemArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AddStorageSystemResult == false)
            return false;
        AddStorageSystemResult other = (AddStorageSystemResult) obj;
    ...
    @Override
    public AddStorageSystemResult clone() {
        try {
            return (AddStorageSystemResult) super.clone();
