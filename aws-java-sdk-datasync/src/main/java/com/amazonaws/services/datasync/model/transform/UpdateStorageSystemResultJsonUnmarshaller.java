...
/**
 * UpdateStorageSystemResult JSON Unmarshaller
 */
...
public class UpdateStorageSystemResultJsonUnmarshaller implements Unmarshaller<UpdateStorageSystemResult, JsonUnmarshallerContext> {
    ...
    public UpdateStorageSystemResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateStorageSystemResult updateStorageSystemResult = new UpdateStorageSystemResult();

        return updateStorageSystemResult;
    }
