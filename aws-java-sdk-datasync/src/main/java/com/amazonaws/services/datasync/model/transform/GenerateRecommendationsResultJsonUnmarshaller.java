...
/**
 * GenerateRecommendationsResult JSON Unmarshaller
 */
...
public class GenerateRecommendationsResultJsonUnmarshaller implements Unmarshaller<GenerateRecommendationsResult, JsonUnmarshallerContext> {
    ...
    public GenerateRecommendationsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GenerateRecommendationsResult generateRecommendationsResult = new GenerateRecommendationsResult();
