...
public class ResourceMetricsMarshaller {
    ...
    private static final MarshallingInfo<StructuredPojo> P95METRICS_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("P95Metrics").build();
    ...
    public void marshall(ResourceMetrics resourceMetrics, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(resourceMetrics.getTimestamp(), TIMESTAMP_BINDING);
            protocolMarshaller.marshall(resourceMetrics.getP95Metrics(), P95METRICS_BINDING);
            protocolMarshaller.marshall(resourceMetrics.getCapacity(), CAPACITY_BINDING);
            protocolMarshaller.marshall(resourceMetrics.getResourceId(), RESOURCEID_BINDING);
            protocolMarshaller.marshall(resourceMetrics.getResourceType(), RESOURCETYPE_BINDING);
        } catch (Exception e) {
