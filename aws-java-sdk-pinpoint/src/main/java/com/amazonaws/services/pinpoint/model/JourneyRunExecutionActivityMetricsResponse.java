 ...
 * activity for a particular journey run, and provides information about that query.
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pinpoint-2016-12-01/JourneyRunExecutionActivityMetricsResponse"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class JourneyRunExecutionActivityMetricsResponse implements Serializable, Cloneable, StructuredPojo {
     ...
     *        activity for this journey run and updated the data for the metric.
     */
     ...
     *
     * @see JourneyRunExecutionActivityMetricsResponse#withMetrics
     * @returns a reference to this object so that method calls can be chained together.
     */

    public JourneyRunExecutionActivityMetricsResponse addMetricsEntry(String key, String value) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof JourneyRunExecutionActivityMetricsResponse == false)
            return false;
        JourneyRunExecutionActivityMetricsResponse other = (JourneyRunExecutionActivityMetricsResponse) obj;
    ...
    public JourneyRunExecutionActivityMetricsResponse clone() {
        try {
            return (JourneyRunExecutionActivityMetricsResponse) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.JourneyRunExecutionActivityMetricsResponseMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
