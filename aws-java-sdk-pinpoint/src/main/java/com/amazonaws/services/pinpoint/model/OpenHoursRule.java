...
public class OpenHoursRule implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OpenHoursRule == false)
            return false;
        OpenHoursRule other = (OpenHoursRule) obj;
    ...
    public OpenHoursRule clone() {
        try {
            return (OpenHoursRule) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pinpoint.model.transform.OpenHoursRuleMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
