...
public class CreatePodIdentityAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * <p>
     * The description includes an ID for the association. Use the ID of the association in further actions to manage
     * the association.
     * </p>
     */
     ...
     * 
     * @param association
     *        The full description of your new association.</p>
     *        <p>
     *        The description includes an ID for the association. Use the ID of the association in further actions to
     ...
     * </p>
     * 
     * @return The full description of your new association.</p>
     *         <p>
     *         The description includes an ID for the association. Use the ID of the association in further actions to
     *         manage the association.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreatePodIdentityAssociationResult == false)
            return false;
        CreatePodIdentityAssociationResult other = (CreatePodIdentityAssociationResult) obj;
    ...
    public CreatePodIdentityAssociationResult clone() {
        try {
            return (CreatePodIdentityAssociationResult) super.clone();
