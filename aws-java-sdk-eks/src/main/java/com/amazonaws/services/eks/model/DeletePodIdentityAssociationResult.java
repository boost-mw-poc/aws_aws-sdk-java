...
public class DeletePodIdentityAssociationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeletePodIdentityAssociationResult == false)
            return false;
        DeletePodIdentityAssociationResult other = (DeletePodIdentityAssociationResult) obj;
    ...
    public DeletePodIdentityAssociationResult clone() {
        try {
            return (DeletePodIdentityAssociationResult) super.clone();
