 ...
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/LambdaEffectiveRecommendationPreferences"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class LambdaEffectiveRecommendationPreferences implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setSavingsEstimationMode(LambdaSavingsEstimationMode savingsEstimationMode) {
    ...
    public LambdaSavingsEstimationMode getSavingsEstimationMode() {
    ...
    public LambdaEffectiveRecommendationPreferences withSavingsEstimationMode(LambdaSavingsEstimationMode savingsEstimationMode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof LambdaEffectiveRecommendationPreferences == false)
            return false;
    ...
    @Override
    public LambdaEffectiveRecommendationPreferences clone() {
        try {
            return (LambdaEffectiveRecommendationPreferences) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.LambdaEffectiveRecommendationPreferencesMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
