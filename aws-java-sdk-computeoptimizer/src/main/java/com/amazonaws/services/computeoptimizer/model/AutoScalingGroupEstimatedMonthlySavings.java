 ...
 * recommendations. This is based on the Savings Plans and Reserved Instances discounts.
 * </p>
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/AutoScalingGroupEstimatedMonthlySavings"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AutoScalingGroupEstimatedMonthlySavings implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AutoScalingGroupEstimatedMonthlySavings == false)
            return false;
    ...
    public AutoScalingGroupEstimatedMonthlySavings clone() {
        try {
            return (AutoScalingGroupEstimatedMonthlySavings) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.AutoScalingGroupEstimatedMonthlySavingsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
