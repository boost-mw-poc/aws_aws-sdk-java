 ...
 * </p>
 * <p>
 * Savings opportunity after discounts represents the estimated monthly savings you can achieve by implementing Compute
 * Optimizer recommendations.
 * </p>
 * 
 * @see <a
 *      href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/InstanceSavingsOpportunityAfterDiscounts"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstanceSavingsOpportunityAfterDiscounts implements Serializable, Cloneable, StructuredPojo {

    /**
     * <p>
     * The estimated monthly savings possible as a percentage of monthly cost after applying the Savings Plans and
     * Reserved Instances discounts. This saving can be achieved by adopting Compute Optimizer’s EC2 instance
     * recommendations.
     * </p>
     */
     ...
     *         and Reserved Instances discounts. This saving can be achieved by adopting Compute Optimizer’s EC2
    ...
    public void setEstimatedMonthlySavings(InstanceEstimatedMonthlySavings estimatedMonthlySavings) {
     ...
     * </p>
     * 
     * @return An object that describes the estimated monthly savings possible by adopting Compute Optimizer’s Amazon
     *         EC2 instance recommendations. This is based on pricing after applying the Savings Plans and Reserved
     *         Instances discounts.
     */

    public InstanceEstimatedMonthlySavings getEstimatedMonthlySavings() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstanceSavingsOpportunityAfterDiscounts == false)
            return false;
        InstanceSavingsOpportunityAfterDiscounts other = (InstanceSavingsOpportunityAfterDiscounts) obj;
    ...
    public InstanceSavingsOpportunityAfterDiscounts clone() {
        try {
            return (InstanceSavingsOpportunityAfterDiscounts) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.InstanceSavingsOpportunityAfterDiscountsMarshaller.getInstance().marshall(this,
                protocolMarshaller);
    }
}
