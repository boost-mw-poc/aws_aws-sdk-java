 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/compute-optimizer-2019-11-01/EBSEstimatedMonthlySavings"
...
public class EBSEstimatedMonthlySavings implements Serializable, Cloneable, StructuredPojo {
    ...
    public EBSEstimatedMonthlySavings withCurrency(String currency) {
    ...
    public EBSEstimatedMonthlySavings withValue(Double value) {
        setValue(value);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof EBSEstimatedMonthlySavings == false)
            return false;
        EBSEstimatedMonthlySavings other = (EBSEstimatedMonthlySavings) obj;
    ...
    @Override
    public EBSEstimatedMonthlySavings clone() {
        try {
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.computeoptimizer.model.transform.EBSEstimatedMonthlySavingsMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
