...
/**
 * PipeEnrichmentHttpParametersMarshaller
 */
...
public class PipeEnrichmentHttpParametersMarshaller {
    ...
    private static final PipeEnrichmentHttpParametersMarshaller instance = new PipeEnrichmentHttpParametersMarshaller();

    public static PipeEnrichmentHttpParametersMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PipeEnrichmentHttpParameters pipeEnrichmentHttpParameters, ProtocolMarshaller protocolMarshaller) {

        if (pipeEnrichmentHttpParameters == null) {
