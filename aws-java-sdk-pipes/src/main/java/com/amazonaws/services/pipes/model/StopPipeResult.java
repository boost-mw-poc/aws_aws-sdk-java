...
public class StopPipeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StopPipeResult withCreationTime(java.util.Date creationTime) {
    ...
    public StopPipeResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopPipeResult == false)
            return false;
        StopPipeResult other = (StopPipeResult) obj;
    ...
    public StopPipeResult clone() {
        try {
            return (StopPipeResult) super.clone();
