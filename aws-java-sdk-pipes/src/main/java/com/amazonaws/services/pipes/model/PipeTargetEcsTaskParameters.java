 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/PipeTargetEcsTaskParameters" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipeTargetEcsTaskParameters implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     */
    private EcsTaskOverride overrides;
    /**
     * <p>
    ...
    public PipeTargetEcsTaskParameters withCapacityProviderStrategy(java.util.Collection<CapacityProviderStrategyItem> capacityProviderStrategy) {
    ...
    public PipeTargetEcsTaskParameters withPlacementConstraints(java.util.Collection<PlacementConstraint> placementConstraints) {
    ...
    public PipeTargetEcsTaskParameters withPlacementStrategy(java.util.Collection<PlacementStrategy> placementStrategy) {
     ...
     *        a task after task creation, use the <code>TagResource</code> API action.
     * @see PropagateTags
     */
    ...
    public void setOverrides(EcsTaskOverride overrides) {
     ...
     * </p>
     * 
     * @return The overrides that are associated with a task.
     */

    public EcsTaskOverride getOverrides() {
    ...
    public PipeTargetEcsTaskParameters withTags(java.util.Collection<Tag> tags) {
        setTags(tags);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getReferenceId() != null)
            sb.append("ReferenceId: ").append("***Sensitive Data Redacted***").append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PipeTargetEcsTaskParameters == false)
            return false;
        PipeTargetEcsTaskParameters other = (PipeTargetEcsTaskParameters) obj;
    ...
    public PipeTargetEcsTaskParameters clone() {
        try {
            return (PipeTargetEcsTaskParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.PipeTargetEcsTaskParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
