...
public class ListPipesRequestMarshaller {
    ...
    public static ListPipesRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListPipesRequest listPipesRequest, ProtocolMarshaller protocolMarshaller) {
