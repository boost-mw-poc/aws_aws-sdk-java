...
/**
 * PipeEnrichmentParametersMarshaller
 */
...
public class PipeEnrichmentParametersMarshaller {
    ...
    public static PipeEnrichmentParametersMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(PipeEnrichmentParameters pipeEnrichmentParameters, ProtocolMarshaller protocolMarshaller) {

        if (pipeEnrichmentParameters == null) {
