 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/UpdatePipeSourceRabbitMQBrokerParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePipeSourceRabbitMQBrokerParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public UpdatePipeSourceRabbitMQBrokerParameters withBatchSize(Integer batchSize) {
    ...
    public UpdatePipeSourceRabbitMQBrokerParameters withMaximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePipeSourceRabbitMQBrokerParameters == false)
            return false;
    ...
    @Override
    public UpdatePipeSourceRabbitMQBrokerParameters clone() {
        try {
            return (UpdatePipeSourceRabbitMQBrokerParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.UpdatePipeSourceRabbitMQBrokerParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
