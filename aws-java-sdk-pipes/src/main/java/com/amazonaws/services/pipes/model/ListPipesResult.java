...
public class ListPipesResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public void setPipes(java.util.Collection<Pipe> pipes) {
        if (pipes == null) {
            this.pipes = null;
            return;
        }

        this.pipes = new java.util.ArrayList<Pipe>(pipes);
    }
     ...
     * {@link #setPipes(java.util.Collection)} or {@link #withPipes(java.util.Collection)} if you want to override the
     * existing values.
     * </p>
     * 
     * @param pipes
    ...
    public ListPipesResult withPipes(Pipe... pipes) {
        if (this.pipes == null) {
            setPipes(new java.util.ArrayList<Pipe>(pipes.length));
        }
        for (Pipe ele : pipes) {
            this.pipes.add(ele);
        }
    ...
    public ListPipesResult withPipes(java.util.Collection<Pipe> pipes) {
        setPipes(pipes);
        return this;
    }
