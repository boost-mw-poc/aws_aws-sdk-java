...
public class StartPipeResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartPipeResult withDesiredState(String desiredState) {
    ...
    public StartPipeResult withDesiredState(RequestedPipeState desiredState) {
    ...
    public StartPipeResult withLastModifiedTime(java.util.Date lastModifiedTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartPipeResult == false)
            return false;
        StartPipeResult other = (StartPipeResult) obj;
    ...
    @Override
    public StartPipeResult clone() {
        try {
            return (StartPipeResult) super.clone();
