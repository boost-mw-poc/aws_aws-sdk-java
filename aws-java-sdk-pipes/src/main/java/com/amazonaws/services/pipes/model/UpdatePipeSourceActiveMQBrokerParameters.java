 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/UpdatePipeSourceActiveMQBrokerParameters"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdatePipeSourceActiveMQBrokerParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public UpdatePipeSourceActiveMQBrokerParameters withMaximumBatchingWindowInSeconds(Integer maximumBatchingWindowInSeconds) {
    ...
    @Override
    public UpdatePipeSourceActiveMQBrokerParameters clone() {
        try {
            return (UpdatePipeSourceActiveMQBrokerParameters) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.UpdatePipeSourceActiveMQBrokerParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
