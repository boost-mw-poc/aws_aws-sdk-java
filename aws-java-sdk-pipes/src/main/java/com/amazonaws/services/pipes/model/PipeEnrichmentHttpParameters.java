 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/PipeEnrichmentHttpParameters" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class PipeEnrichmentHttpParameters implements Serializable, Cloneable, StructuredPojo {
    ...
    public PipeEnrichmentHttpParameters withPathParameterValues(java.util.Collection<String> pathParameterValues) {
     ...
     *
     * @see PipeEnrichmentHttpParameters#withHeaderParameters
     ...
     *
     * @see PipeEnrichmentHttpParameters#withQueryStringParameters
     * @returns a reference to this object so that method calls can be chained together.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PipeEnrichmentHttpParameters == false)
            return false;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.PipeEnrichmentHttpParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
