 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/pipes-2015-10-07/PipeSourceDynamoDBStreamParameters"
...
public class PipeSourceDynamoDBStreamParameters implements Serializable, Cloneable, StructuredPojo {
     ...
     *        (Streams only) The position in a stream from which to start reading.
     * @see DynamoDBStreamStartPosition
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PipeSourceDynamoDBStreamParameters == false)
            return false;
        PipeSourceDynamoDBStreamParameters other = (PipeSourceDynamoDBStreamParameters) obj;
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.pipes.model.transform.PipeSourceDynamoDBStreamParametersMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
