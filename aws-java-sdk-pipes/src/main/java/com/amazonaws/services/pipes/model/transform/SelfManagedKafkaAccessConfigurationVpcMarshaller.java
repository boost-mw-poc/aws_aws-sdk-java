...
/**
 * SelfManagedKafkaAccessConfigurationVpcMarshaller
 */
...
public class SelfManagedKafkaAccessConfigurationVpcMarshaller {
    ...
    public static SelfManagedKafkaAccessConfigurationVpcMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(SelfManagedKafkaAccessConfigurationVpc selfManagedKafkaAccessConfigurationVpc, ProtocolMarshaller protocolMarshaller) {

        if (selfManagedKafkaAccessConfigurationVpc == null) {
