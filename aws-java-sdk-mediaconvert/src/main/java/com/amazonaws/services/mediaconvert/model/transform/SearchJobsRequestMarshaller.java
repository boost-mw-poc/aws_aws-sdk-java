...
public class SearchJobsRequestMarshaller {
    ...
    private static final MarshallingInfo<String> INPUTFILE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.QUERY_PARAM).marshallLocationName("inputFile").build();
    ...
    public void marshall(SearchJobsRequest searchJobsRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(searchJobsRequest.getInputFile(), INPUTFILE_BINDING);
            ...
            protocolMarshaller.marshall(searchJobsRequest.getOrder(), ORDER_BINDING);
            protocolMarshaller.marshall(searchJobsRequest.getQueue(), QUEUE_BINDING);
            protocolMarshaller.marshall(searchJobsRequest.getStatus(), STATUS_BINDING);
        } catch (Exception e) {
