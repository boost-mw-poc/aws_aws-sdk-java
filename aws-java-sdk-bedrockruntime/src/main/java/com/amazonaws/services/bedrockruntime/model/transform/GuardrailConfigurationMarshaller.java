...
public class GuardrailConfigurationMarshaller {
    ...
    private static final MarshallingInfo<String> TRACE_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
    ...
    public void marshall(GuardrailConfiguration guardrailConfiguration, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(guardrailConfiguration.getTrace(), TRACE_BINDING);
        } catch (Exception e) {
