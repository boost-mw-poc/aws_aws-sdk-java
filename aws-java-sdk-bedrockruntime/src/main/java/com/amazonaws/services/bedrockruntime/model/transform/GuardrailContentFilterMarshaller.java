...
public class GuardrailContentFilterMarshaller {
    ...
    public void marshall(GuardrailContentFilter guardrailContentFilter, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(guardrailContentFilter.getConfidence(), CONFIDENCE_BINDING);
            protocolMarshaller.marshall(guardrailContentFilter.getAction(), ACTION_BINDING);
        } catch (Exception e) {
