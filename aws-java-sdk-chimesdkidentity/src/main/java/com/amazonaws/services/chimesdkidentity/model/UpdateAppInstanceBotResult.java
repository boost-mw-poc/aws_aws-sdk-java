...
public class UpdateAppInstanceBotResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateAppInstanceBotResult withAppInstanceBotArn(String appInstanceBotArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateAppInstanceBotResult == false)
            return false;
        UpdateAppInstanceBotResult other = (UpdateAppInstanceBotResult) obj;
    ...
    @Override
    public UpdateAppInstanceBotResult clone() {
        try {
            return (UpdateAppInstanceBotResult) super.clone();
