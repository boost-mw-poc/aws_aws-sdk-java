...
public class DeleteAppInstanceBotRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ARN of the <code>AppInstanceBot</code> being deleted.
     */
    ...
    public DeleteAppInstanceBotRequest withAppInstanceBotArn(String appInstanceBotArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DeleteAppInstanceBotRequest == false)
            return false;
        DeleteAppInstanceBotRequest other = (DeleteAppInstanceBotRequest) obj;
    ...
    public DeleteAppInstanceBotRequest clone() {
        return (DeleteAppInstanceBotRequest) super.clone();
    }
