...
/**
 * DeleteAppInstanceBotResult JSON Unmarshaller
 */
...
public class DeleteAppInstanceBotResultJsonUnmarshaller implements Unmarshaller<DeleteAppInstanceBotResult, JsonUnmarshallerContext> {
    ...
    public DeleteAppInstanceBotResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteAppInstanceBotResult deleteAppInstanceBotResult = new DeleteAppInstanceBotResult();

        return deleteAppInstanceBotResult;
    }
