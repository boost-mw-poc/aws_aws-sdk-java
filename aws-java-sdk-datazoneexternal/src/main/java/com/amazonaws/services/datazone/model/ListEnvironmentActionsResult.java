...
public class ListEnvironmentActionsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     */
    private java.util.List<EnvironmentActionSummary> items;
    /**
     * <p>
     ...
     * </p>
     * 
     * @return The results of <code>ListEnvironmentActions</code>.
     */

    public java.util.List<EnvironmentActionSummary> getItems() {
        return items;
    }
    ...
    public void setItems(java.util.Collection<EnvironmentActionSummary> items) {
        if (items == null) {
            this.items = null;
            return;
        }

        this.items = new java.util.ArrayList<EnvironmentActionSummary>(items);
    }
    ...
    public ListEnvironmentActionsResult withItems(EnvironmentActionSummary... items) {
        if (this.items == null) {
            setItems(new java.util.ArrayList<EnvironmentActionSummary>(items.length));
        }
        for (EnvironmentActionSummary ele : items) {
            this.items.add(ele);
        }
        return this;
    }
    ...
    public ListEnvironmentActionsResult withItems(java.util.Collection<EnvironmentActionSummary> items) {
        setItems(items);
        return this;
    }
    ...
    public ListEnvironmentActionsResult withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListEnvironmentActionsResult == false)
            return false;
        ListEnvironmentActionsResult other = (ListEnvironmentActionsResult) obj;
    ...
    public ListEnvironmentActionsResult clone() {
        try {
            return (ListEnvironmentActionsResult) super.clone();
