...
/**
 * DeleteEnvironmentActionResult JSON Unmarshaller
 */
...
public class DeleteEnvironmentActionResultJsonUnmarshaller implements Unmarshaller<DeleteEnvironmentActionResult, JsonUnmarshallerContext> {
    ...
    public DeleteEnvironmentActionResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteEnvironmentActionResult deleteEnvironmentActionResult = new DeleteEnvironmentActionResult();

        return deleteEnvironmentActionResult;
    }
