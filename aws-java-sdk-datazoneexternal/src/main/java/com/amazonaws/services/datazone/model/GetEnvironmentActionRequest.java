...
public class GetEnvironmentActionRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    /**
     * <p>
     * The ID of the Amazon DataZone domain in which the <code>GetEnvironmentAction</code> API is invoked.
     * </p>
     */
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which the <code>GetEnvironmentAction</code> API is invoked.
     */
    ...
    public GetEnvironmentActionRequest withDomainIdentifier(String domainIdentifier) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEnvironmentActionRequest == false)
            return false;
        GetEnvironmentActionRequest other = (GetEnvironmentActionRequest) obj;
    ...
    public GetEnvironmentActionRequest clone() {
        return (GetEnvironmentActionRequest) super.clone();
    }
