 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/GlueSelfGrantStatusOutput" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GlueSelfGrantStatusOutput implements Serializable, Cloneable, StructuredPojo {
    ...
    public GlueSelfGrantStatusOutput withSelfGrantStatusDetails(SelfGrantStatusDetail... selfGrantStatusDetails) {
    ...
    public GlueSelfGrantStatusOutput withSelfGrantStatusDetails(java.util.Collection<SelfGrantStatusDetail> selfGrantStatusDetails) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GlueSelfGrantStatusOutput == false)
            return false;
    ...
    public GlueSelfGrantStatusOutput clone() {
        try {
            return (GlueSelfGrantStatusOutput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.datazone.model.transform.GlueSelfGrantStatusOutputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
