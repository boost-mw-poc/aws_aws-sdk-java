...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/datazone-2018-05-10/GetEnvironmentCredentials" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetEnvironmentCredentialsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the Amazon DataZone domain in which this environment and its credentials exist.
     */
     ...
     * </p>
     * 
     * @return The ID of the environment whose credentials this operation gets.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEnvironmentCredentialsRequest == false)
            return false;
        GetEnvironmentCredentialsRequest other = (GetEnvironmentCredentialsRequest) obj;
    ...
    public GetEnvironmentCredentialsRequest clone() {
        return (GetEnvironmentCredentialsRequest) super.clone();
    }
