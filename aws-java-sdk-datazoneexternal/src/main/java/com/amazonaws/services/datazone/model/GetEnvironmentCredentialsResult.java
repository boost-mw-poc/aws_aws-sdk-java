...
public class GetEnvironmentCredentialsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public GetEnvironmentCredentialsResult withExpiration(java.util.Date expiration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetEnvironmentCredentialsResult == false)
            return false;
        GetEnvironmentCredentialsResult other = (GetEnvironmentCredentialsResult) obj;
    ...
    public GetEnvironmentCredentialsResult clone() {
        try {
            return (GetEnvironmentCredentialsResult) super.clone();
