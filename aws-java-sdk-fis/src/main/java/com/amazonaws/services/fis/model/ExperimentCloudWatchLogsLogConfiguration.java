 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/fis-2020-12-01/ExperimentCloudWatchLogsLogConfiguration"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class ExperimentCloudWatchLogsLogConfiguration implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ExperimentCloudWatchLogsLogConfiguration == false)
            return false;
        ExperimentCloudWatchLogsLogConfiguration other = (ExperimentCloudWatchLogsLogConfiguration) obj;
    ...
    public ExperimentCloudWatchLogsLogConfiguration clone() {
        try {
            return (ExperimentCloudWatchLogsLogConfiguration) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.fis.model.transform.ExperimentCloudWatchLogsLogConfigurationMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
