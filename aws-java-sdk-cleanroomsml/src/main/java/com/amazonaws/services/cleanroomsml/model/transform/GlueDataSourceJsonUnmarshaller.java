...
/**
 * GlueDataSource JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GlueDataSourceJsonUnmarshaller implements Unmarshaller<GlueDataSource, JsonUnmarshallerContext> {

    public GlueDataSource unmarshall(JsonUnmarshallerContext context) throws Exception {
        GlueDataSource glueDataSource = new GlueDataSource();
    ...
    private static GlueDataSourceJsonUnmarshaller instance;

    public static GlueDataSourceJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GlueDataSourceJsonUnmarshaller();
        return instance;
    }
}
