...
/**
 * AudienceGenerationJobSummaryMarshaller
 */
...
public class AudienceGenerationJobSummaryMarshaller {
    ...
    public static AudienceGenerationJobSummaryMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AudienceGenerationJobSummary audienceGenerationJobSummary, ProtocolMarshaller protocolMarshaller) {

        if (audienceGenerationJobSummary == null) {
