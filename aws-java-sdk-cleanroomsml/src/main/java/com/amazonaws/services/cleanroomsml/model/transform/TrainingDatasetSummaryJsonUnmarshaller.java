...
/**
 * TrainingDatasetSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class TrainingDatasetSummaryJsonUnmarshaller implements Unmarshaller<TrainingDatasetSummary, JsonUnmarshallerContext> {

    public TrainingDatasetSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        TrainingDatasetSummary trainingDatasetSummary = new TrainingDatasetSummary();
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("name", targetDepth)) {
                    context.nextToken();
                    trainingDatasetSummary.setName(context.getUnmarshaller(String.class).unmarshall(context));
                }
    ...
    private static TrainingDatasetSummaryJsonUnmarshaller instance;

    public static TrainingDatasetSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new TrainingDatasetSummaryJsonUnmarshaller();
        return instance;
    }
}
