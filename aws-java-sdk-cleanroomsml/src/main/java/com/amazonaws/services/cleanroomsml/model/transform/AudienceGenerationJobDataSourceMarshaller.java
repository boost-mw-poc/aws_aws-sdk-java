...
/**
 * AudienceGenerationJobDataSourceMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class AudienceGenerationJobDataSourceMarshaller {
    ...
    public static AudienceGenerationJobDataSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(AudienceGenerationJobDataSource audienceGenerationJobDataSource, ProtocolMarshaller protocolMarshaller) {

        if (audienceGenerationJobDataSource == null) {
