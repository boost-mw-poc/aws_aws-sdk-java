...
/**
 * AudienceGenerationJobSummary JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AudienceGenerationJobSummaryJsonUnmarshaller implements Unmarshaller<AudienceGenerationJobSummary, JsonUnmarshallerContext> {

    public AudienceGenerationJobSummary unmarshall(JsonUnmarshallerContext context) throws Exception {
        AudienceGenerationJobSummary audienceGenerationJobSummary = new AudienceGenerationJobSummary();
    ...
    private static AudienceGenerationJobSummaryJsonUnmarshaller instance;

    public static AudienceGenerationJobSummaryJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AudienceGenerationJobSummaryJsonUnmarshaller();
        return instance;
    }
}
