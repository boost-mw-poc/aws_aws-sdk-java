...
public class ListAudienceModelsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListAudienceModelsRequest withNextToken(String nextToken) {
    ...
    @Override
    public ListAudienceModelsRequest clone() {
        return (ListAudienceModelsRequest) super.clone();
    }
