...
public class GlueDataSourceMarshaller {
    ...
    public static GlueDataSourceMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GlueDataSource glueDataSource, ProtocolMarshaller protocolMarshaller) {

        if (glueDataSource == null) {
