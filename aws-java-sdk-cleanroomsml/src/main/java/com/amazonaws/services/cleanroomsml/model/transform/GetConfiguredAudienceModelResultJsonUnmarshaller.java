...
/**
 * GetConfiguredAudienceModelResult JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetConfiguredAudienceModelResultJsonUnmarshaller implements Unmarshaller<GetConfiguredAudienceModelResult, JsonUnmarshallerContext> {

    public GetConfiguredAudienceModelResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        GetConfiguredAudienceModelResult getConfiguredAudienceModelResult = new GetConfiguredAudienceModelResult();
        ...
        if (token == VALUE_NULL) {
            return getConfiguredAudienceModelResult;
        }
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("sharedAudienceMetrics", targetDepth)) {
                    context.nextToken();
                    getConfiguredAudienceModelResult.setSharedAudienceMetrics(new ListUnmarshaller<String>(context.getUnmarshaller(String.class))
    ...
    private static GetConfiguredAudienceModelResultJsonUnmarshaller instance;

    public static GetConfiguredAudienceModelResultJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new GetConfiguredAudienceModelResultJsonUnmarshaller();
        return instance;
    }
}
