...
/**
 * InterpretationMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class InterpretationMarshaller {

    private static final MarshallingInfo<StructuredPojo> NLUCONFIDENCE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("nluConfidence").build();
    private static final MarshallingInfo<StructuredPojo> SENTIMENTRESPONSE_BINDING = MarshallingInfo.builder(MarshallingType.STRUCTURED)
    ...
    public static InterpretationMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(Interpretation interpretation, ProtocolMarshaller protocolMarshaller) {
