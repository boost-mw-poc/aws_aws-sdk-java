...
/**
 * CustomExtension JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class CustomExtensionJsonUnmarshaller implements Unmarshaller<CustomExtension, JsonUnmarshallerContext> {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("ObjectIdentifier", targetDepth)) {
                    context.nextToken();
                    customExtension.setObjectIdentifier(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Value", targetDepth)) {
                    context.nextToken();
                    customExtension.setValue(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("Critical", targetDepth)) {
                    context.nextToken();
                    customExtension.setCritical(context.getUnmarshaller(Boolean.class).unmarshall(context));
                }
