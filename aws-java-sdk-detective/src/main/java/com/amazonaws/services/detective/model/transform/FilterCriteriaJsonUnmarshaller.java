        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("Severity", targetDepth)) {
                    context.nextToken();
                    filterCriteria.setSeverity(StringFilterJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("Status", targetDepth)) {
                    context.nextToken();
                    filterCriteria.setStatus(StringFilterJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("State", targetDepth)) {
                    context.nextToken();
                    filterCriteria.setState(StringFilterJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("EntityArn", targetDepth)) {
                    context.nextToken();
                    filterCriteria.setEntityArn(StringFilterJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("CreatedTime", targetDepth)) {
                    context.nextToken();
                    filterCriteria.setCreatedTime(DateFilterJsonUnmarshaller.getInstance().unmarshall(context));
                }
