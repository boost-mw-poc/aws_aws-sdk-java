...
/**
 * UpdateInvestigationStateResult JSON Unmarshaller
 */
...
public class UpdateInvestigationStateResultJsonUnmarshaller implements Unmarshaller<UpdateInvestigationStateResult, JsonUnmarshallerContext> {
    ...
    public UpdateInvestigationStateResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        UpdateInvestigationStateResult updateInvestigationStateResult = new UpdateInvestigationStateResult();

        return updateInvestigationStateResult;
    }
