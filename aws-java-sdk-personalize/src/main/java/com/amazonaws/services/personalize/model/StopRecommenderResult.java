...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/personalize-2018-05-22/StopRecommender" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class StopRecommenderResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The Amazon Resource Name (ARN) of the recommender you stopped.
     */
    ...
    public StopRecommenderResult withRecommenderArn(String recommenderArn) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StopRecommenderResult == false)
            return false;
        StopRecommenderResult other = (StopRecommenderResult) obj;
    ...
    @Override
    public StopRecommenderResult clone() {
        try {
            return (StopRecommenderResult) super.clone();
