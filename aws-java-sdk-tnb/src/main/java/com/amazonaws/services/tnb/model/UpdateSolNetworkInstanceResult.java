...
public class UpdateSolNetworkInstanceResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateSolNetworkInstanceResult withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see UpdateSolNetworkInstanceResult#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateSolNetworkInstanceResult addTagsEntry(String key, String value) {
        if (null == this.tags) {
