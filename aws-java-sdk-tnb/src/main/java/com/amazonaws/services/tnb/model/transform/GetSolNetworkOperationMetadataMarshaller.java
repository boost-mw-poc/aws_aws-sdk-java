...
/**
 * GetSolNetworkOperationMetadataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class GetSolNetworkOperationMetadataMarshaller {
    ...
    public static GetSolNetworkOperationMetadataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(GetSolNetworkOperationMetadata getSolNetworkOperationMetadata, ProtocolMarshaller protocolMarshaller) {

        if (getSolNetworkOperationMetadata == null) {
