...
public class CreateSolFunctionPackageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateSolFunctionPackageRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateSolFunctionPackageRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateSolFunctionPackageRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSolFunctionPackageRequest == false)
            return false;
        CreateSolFunctionPackageRequest other = (CreateSolFunctionPackageRequest) obj;
    ...
    @Override
    public CreateSolFunctionPackageRequest clone() {
        return (CreateSolFunctionPackageRequest) super.clone();
    }
