...
public class ListSolNetworkOperationsRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public ListSolNetworkOperationsRequest withMaxResults(Integer maxResults) {
    ...
    public ListSolNetworkOperationsRequest withNextToken(String nextToken) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ListSolNetworkOperationsRequest == false)
            return false;
        ListSolNetworkOperationsRequest other = (ListSolNetworkOperationsRequest) obj;
    ...
    @Override
    public ListSolNetworkOperationsRequest clone() {
        return (ListSolNetworkOperationsRequest) super.clone();
    }
