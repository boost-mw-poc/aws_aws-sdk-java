...
/**
 * DeleteSolNetworkInstanceResult JSON Unmarshaller
 */
...
public class DeleteSolNetworkInstanceResultJsonUnmarshaller implements Unmarshaller<DeleteSolNetworkInstanceResult, JsonUnmarshallerContext> {
    ...
    public DeleteSolNetworkInstanceResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSolNetworkInstanceResult deleteSolNetworkInstanceResult = new DeleteSolNetworkInstanceResult();

        return deleteSolNetworkInstanceResult;
    }
