 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/tnb-2008-10-21/UpdateSolNetworkServiceData" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateSolNetworkServiceData implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateSolNetworkServiceData == false)
            return false;
    ...
    public UpdateSolNetworkServiceData clone() {
        try {
            return (UpdateSolNetworkServiceData) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.tnb.model.transform.UpdateSolNetworkServiceDataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
