 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/tnb-2008-10-21/InstantiateMetadata" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class InstantiateMetadata implements Serializable, Cloneable, StructuredPojo {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof InstantiateMetadata == false)
            return false;
    ...
    public InstantiateMetadata clone() {
        try {
            return (InstantiateMetadata) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.tnb.model.transform.InstantiateMetadataMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
