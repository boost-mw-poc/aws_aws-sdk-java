...
/**
 * DeleteSolFunctionPackageResult JSON Unmarshaller
 */
...
public class DeleteSolFunctionPackageResultJsonUnmarshaller implements Unmarshaller<DeleteSolFunctionPackageResult, JsonUnmarshallerContext> {
    ...
    public DeleteSolFunctionPackageResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        DeleteSolFunctionPackageResult deleteSolFunctionPackageResult = new DeleteSolFunctionPackageResult();

        return deleteSolFunctionPackageResult;
    }
