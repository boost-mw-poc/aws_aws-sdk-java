...
/**
 * GetSolFunctionPackageContentResult JSON Unmarshaller
 */
...
public class GetSolFunctionPackageContentResultJsonUnmarshaller implements Unmarshaller<GetSolFunctionPackageContentResult, JsonUnmarshallerContext> {
    ...
    public GetSolFunctionPackageContentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        if (context.isStartOfDocument()) {
            if (context.getHeader("Content-Type") != null) {
                ...
                getSolFunctionPackageContentResult.setContentType(context.getUnmarshaller(String.class).unmarshall(context));
            }
        }
        ...
        if (is != null) {
            try {
                getSolFunctionPackageContentResult.setPackageContent(java.nio.ByteBuffer.wrap(com.amazonaws.util.IOUtils.toByteArray(is)));
            } finally {
