 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/tnb-2008-10-21/NetworkArtifactMeta" target="_top">AWS API
 *      Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class NetworkArtifactMeta implements Serializable, Cloneable, StructuredPojo {
     ...
     * </p>
     * 
     * @return Lists network package overrides.
     */
    ...
    public NetworkArtifactMeta withOverrides(ToscaOverride... overrides) {
    ...
    public NetworkArtifactMeta withOverrides(java.util.Collection<ToscaOverride> overrides) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NetworkArtifactMeta == false)
            return false;
        NetworkArtifactMeta other = (NetworkArtifactMeta) obj;
    ...
    public NetworkArtifactMeta clone() {
        try {
            return (NetworkArtifactMeta) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.tnb.model.transform.NetworkArtifactMetaMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
