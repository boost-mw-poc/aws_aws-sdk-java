...
/**
 * ListSolNetworkOperationsMetadataMarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
@SdkInternalApi
public class ListSolNetworkOperationsMetadataMarshaller {
    ...
    public static ListSolNetworkOperationsMetadataMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(ListSolNetworkOperationsMetadata listSolNetworkOperationsMetadata, ProtocolMarshaller protocolMarshaller) {

        if (listSolNetworkOperationsMetadata == null) {
