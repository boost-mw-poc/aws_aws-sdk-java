...
public class CreateSolNetworkPackageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public CreateSolNetworkPackageRequest withTags(java.util.Map<String, String> tags) {
        setTags(tags);
        return this;
    }
     ...
     *
     * @see CreateSolNetworkPackageRequest#withTags
     * @returns a reference to this object so that method calls can be chained together.
     */

    public CreateSolNetworkPackageRequest addTagsEntry(String key, String value) {
        if (null == this.tags) {
    ...
    public CreateSolNetworkPackageRequest clearTagsEntries() {
        this.tags = null;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CreateSolNetworkPackageRequest == false)
            return false;
        CreateSolNetworkPackageRequest other = (CreateSolNetworkPackageRequest) obj;
    ...
    @Override
    public CreateSolNetworkPackageRequest clone() {
        return (CreateSolNetworkPackageRequest) super.clone();
    }
