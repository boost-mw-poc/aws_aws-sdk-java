...
public class GetSolNetworkPackageRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
    ...
    public GetSolNetworkPackageRequest withNsdInfoId(String nsdInfoId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetSolNetworkPackageRequest == false)
            return false;
        GetSolNetworkPackageRequest other = (GetSolNetworkPackageRequest) obj;
    ...
    @Override
    public GetSolNetworkPackageRequest clone() {
        return (GetSolNetworkPackageRequest) super.clone();
    }
