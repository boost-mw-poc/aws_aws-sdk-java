...
public class UpdateSolNetworkInstanceRequestMarshaller {
    ...
    private static final UpdateSolNetworkInstanceRequestMarshaller instance = new UpdateSolNetworkInstanceRequestMarshaller();

    public static UpdateSolNetworkInstanceRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdateSolNetworkInstanceRequest updateSolNetworkInstanceRequest, ProtocolMarshaller protocolMarshaller) {
