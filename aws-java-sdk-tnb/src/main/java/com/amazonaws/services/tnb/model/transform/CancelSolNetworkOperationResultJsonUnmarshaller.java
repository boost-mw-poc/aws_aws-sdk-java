...
/**
 * CancelSolNetworkOperationResult JSON Unmarshaller
 */
...
public class CancelSolNetworkOperationResultJsonUnmarshaller implements Unmarshaller<CancelSolNetworkOperationResult, JsonUnmarshallerContext> {
    ...
    public CancelSolNetworkOperationResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        CancelSolNetworkOperationResult cancelSolNetworkOperationResult = new CancelSolNetworkOperationResult();

        return cancelSolNetworkOperationResult;
    }
