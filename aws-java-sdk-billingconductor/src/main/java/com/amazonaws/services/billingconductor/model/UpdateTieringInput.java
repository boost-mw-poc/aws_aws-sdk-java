 ...
 * </p>
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/billingconductor-2021-07-30/UpdateTieringInput"
 *      target="_top">AWS API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateTieringInput implements Serializable, Cloneable, StructuredPojo {
    ...
    public UpdateFreeTierConfig getFreeTier() {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdateTieringInput == false)
            return false;
    ...
    public UpdateTieringInput clone() {
        try {
            return (UpdateTieringInput) super.clone();
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        com.amazonaws.services.billingconductor.model.transform.UpdateTieringInputMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
