...
public class UpdatePricingRuleRequestMarshaller {
    ...
    public static UpdatePricingRuleRequestMarshaller getInstance() {
        return instance;
    }
     ...
     */
    public void marshall(UpdatePricingRuleRequest updatePricingRuleRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updatePricingRuleRequest.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(updatePricingRuleRequest.getName(), NAME_BINDING);
