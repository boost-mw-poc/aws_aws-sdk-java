...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.billingconductor.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.billingconductor.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context) throws Exception {
        com.amazonaws.services.billingconductor.model.ThrottlingException throttlingException = new com.amazonaws.services.billingconductor.model.ThrottlingException(
                null);
