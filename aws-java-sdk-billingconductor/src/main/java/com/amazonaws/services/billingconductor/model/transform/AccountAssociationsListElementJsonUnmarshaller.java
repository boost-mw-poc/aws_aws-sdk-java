...
/**
 * AccountAssociationsListElement JSON Unmarshaller
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class AccountAssociationsListElementJsonUnmarshaller implements Unmarshaller<AccountAssociationsListElement, JsonUnmarshallerContext> {

    public AccountAssociationsListElement unmarshall(JsonUnmarshallerContext context) throws Exception {
        AccountAssociationsListElement accountAssociationsListElement = new AccountAssociationsListElement();
    ...
    private static AccountAssociationsListElementJsonUnmarshaller instance;

    public static AccountAssociationsListElementJsonUnmarshaller getInstance() {
        if (instance == null)
            instance = new AccountAssociationsListElementJsonUnmarshaller();
        return instance;
    }
}
