...
public class UpdatePricingPlanRequestMarshaller {
    ...
    public void marshall(UpdatePricingPlanRequest updatePricingPlanRequest, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(updatePricingPlanRequest.getArn(), ARN_BINDING);
            protocolMarshaller.marshall(updatePricingPlanRequest.getName(), NAME_BINDING);
            protocolMarshaller.marshall(updatePricingPlanRequest.getDescription(), DESCRIPTION_BINDING);
        } catch (Exception e) {
