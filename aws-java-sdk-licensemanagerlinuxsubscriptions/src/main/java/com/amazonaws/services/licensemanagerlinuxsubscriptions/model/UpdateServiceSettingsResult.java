...
public class UpdateServiceSettingsResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public UpdateServiceSettingsResult withHomeRegions(String... homeRegions) {
    ...
    public UpdateServiceSettingsResult withHomeRegions(java.util.Collection<String> homeRegions) {
    ...
    public UpdateServiceSettingsResult withLinuxSubscriptionsDiscovery(String linuxSubscriptionsDiscovery) {
    ...
    public UpdateServiceSettingsResult withLinuxSubscriptionsDiscovery(LinuxSubscriptionsDiscovery linuxSubscriptionsDiscovery) {
    ...
    public UpdateServiceSettingsResult withLinuxSubscriptionsDiscoverySettings(LinuxSubscriptionsDiscoverySettings linuxSubscriptionsDiscoverySettings) {
    ...
    public UpdateServiceSettingsResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public UpdateServiceSettingsResult withStatus(Status status) {
    ...
    public UpdateServiceSettingsResult withStatusMessage(java.util.Map<String, String> statusMessage) {
     ...
     *
     * @see UpdateServiceSettingsResult#withStatusMessage
     * @returns a reference to this object so that method calls can be chained together.
     */

    public UpdateServiceSettingsResult addStatusMessageEntry(String key, String value) {
    ...
    public UpdateServiceSettingsResult clearStatusMessageEntries() {
