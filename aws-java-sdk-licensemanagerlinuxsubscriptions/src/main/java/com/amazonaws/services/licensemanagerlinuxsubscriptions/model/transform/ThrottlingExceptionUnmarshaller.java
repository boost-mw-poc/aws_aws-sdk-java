...
public class ThrottlingExceptionUnmarshaller extends EnhancedJsonErrorUnmarshaller {
    private ThrottlingExceptionUnmarshaller() {
        super(com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ThrottlingException.class, "ThrottlingException");
    }

    @Override
    public com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ThrottlingException unmarshallFromContext(JsonUnmarshallerContext context)
            throws Exception {
        com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ThrottlingException throttlingException = new com.amazonaws.services.licensemanagerlinuxsubscriptions.model.ThrottlingException(
                null);
