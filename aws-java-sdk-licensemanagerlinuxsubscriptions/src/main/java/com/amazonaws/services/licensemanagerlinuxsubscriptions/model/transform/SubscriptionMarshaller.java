...
public class SubscriptionMarshaller {
    ...
    private static final MarshallingInfo<Long> INSTANCECOUNT_BINDING = MarshallingInfo.builder(MarshallingType.LONG).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("InstanceCount").build();
    ...
    public void marshall(Subscription subscription, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            protocolMarshaller.marshall(subscription.getInstanceCount(), INSTANCECOUNT_BINDING);
            protocolMarshaller.marshall(subscription.getName(), NAME_BINDING);
            protocolMarshaller.marshall(subscription.getType(), TYPE_BINDING);
        } catch (Exception e) {
