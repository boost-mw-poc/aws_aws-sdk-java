...
public class CancelZonalShiftResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public CancelZonalShiftResult withAwayFrom(String awayFrom) {
    ...
    public CancelZonalShiftResult withComment(String comment) {
        setComment(comment);
        return this;
    }
    ...
    public CancelZonalShiftResult withExpiryTime(java.util.Date expiryTime) {
    ...
    public CancelZonalShiftResult withResourceIdentifier(String resourceIdentifier) {
    ...
    public CancelZonalShiftResult withStartTime(java.util.Date startTime) {
    ...
    public CancelZonalShiftResult withStatus(String status) {
        setStatus(status);
        return this;
    }
    ...
    public CancelZonalShiftResult withStatus(ZonalShiftStatus status) {
    ...
    public CancelZonalShiftResult withZonalShiftId(String zonalShiftId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CancelZonalShiftResult == false)
            return false;
        CancelZonalShiftResult other = (CancelZonalShiftResult) obj;
    ...
    @Override
    public CancelZonalShiftResult clone() {
        try {
            return (CancelZonalShiftResult) super.clone();
