...
public class UpdatePracticeRunConfigurationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable,
        Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof UpdatePracticeRunConfigurationResult == false)
            return false;
        UpdatePracticeRunConfigurationResult other = (UpdatePracticeRunConfigurationResult) obj;
    ...
    public UpdatePracticeRunConfigurationResult clone() {
        try {
            return (UpdatePracticeRunConfigurationResult) super.clone();
