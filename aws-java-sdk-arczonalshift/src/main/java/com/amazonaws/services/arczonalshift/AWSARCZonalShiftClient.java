...
public class AWSARCZonalShiftClient extends AmazonWebServiceClient implements AWSARCZonalShift {
    ...
    final GetAutoshiftObserverNotificationStatusResult executeGetAutoshiftObserverNotificationStatus(
        ...
        Response<GetAutoshiftObserverNotificationStatusResult> response = null;
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<GetAutoshiftObserverNotificationStatusResult>> responseHandler = protocolFactory
    ...
    final UpdateAutoshiftObserverNotificationStatusResult executeUpdateAutoshiftObserverNotificationStatus(
        ...
        Response<UpdateAutoshiftObserverNotificationStatusResult> response = null;
        ...
        try {
            ...
            HttpResponseHandler<AmazonWebServiceResponse<UpdateAutoshiftObserverNotificationStatusResult>> responseHandler = protocolFactory
                    .createResponseHandler(new JsonOperationMetadata().withPayloadJson(true).withHasStreamingSuccessResponse(false),
