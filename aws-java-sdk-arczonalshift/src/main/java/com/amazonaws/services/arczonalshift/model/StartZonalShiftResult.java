...
public class StartZonalShiftResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.ResponseMetadata> implements Serializable, Cloneable {
    ...
    public StartZonalShiftResult withAwayFrom(String awayFrom) {
    ...
    public StartZonalShiftResult withExpiryTime(java.util.Date expiryTime) {
    ...
    public StartZonalShiftResult withStartTime(java.util.Date startTime) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof StartZonalShiftResult == false)
            return false;
        StartZonalShiftResult other = (StartZonalShiftResult) obj;
    ...
    public StartZonalShiftResult clone() {
        try {
            return (StartZonalShiftResult) super.clone();
