...
/**
 * GetAccessGrantsInstanceForPrefixResult StAX Unmarshaller
 */
...
public class GetAccessGrantsInstanceForPrefixResultStaxUnmarshaller implements Unmarshaller<GetAccessGrantsInstanceForPrefixResult, StaxUnmarshallerContext> {
    ...
    public GetAccessGrantsInstanceForPrefixResult unmarshall(StaxUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
                ...
                if (context.testExpression("AccessGrantsInstanceArn", targetDepth)) {
                    getAccessGrantsInstanceForPrefixResult.setAccessGrantsInstanceArn(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }

                if (context.testExpression("AccessGrantsInstanceId", targetDepth)) {
                    getAccessGrantsInstanceForPrefixResult.setAccessGrantsInstanceId(StringStaxUnmarshaller.getInstance().unmarshall(context));
                    continue;
                }
