...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/s3control-2018-08-20/GetAccessGrantsLocation" target="_top">AWS
 *      API Documentation</a>
 */
@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class GetAccessGrantsLocationResult extends com.amazonaws.AmazonWebServiceResult<com.amazonaws.services.s3control.S3ControlResponseMetadata> implements
    ...
    /**
     * <p>
     * The S3 URI path to the registered location. The location scope can be the default S3 location <code>s3://</code>,
    ...
    public GetAccessGrantsLocationResult withCreatedAt(java.util.Date createdAt) {
    ...
    public GetAccessGrantsLocationResult withAccessGrantsLocationId(String accessGrantsLocationId) {
     ...
     *        <code>s3://</code>, the S3 path to a bucket, or the S3 path to a bucket and prefix. A prefix in S3 is a
     *        string of characters at the beginning of an object key name used to organize the objects that you store in
     *        your S3 buckets. For example, object key names that start with the <code>engineering/</code> prefix or
     ...
     * </p>
     * 
     * @return The S3 URI path to the registered location. The location scope can be the default S3 location
     *         <code>s3://</code>, the S3 path to a bucket, or the S3 path to a bucket and prefix. A prefix in S3 is a
     *         string of characters at the beginning of an object key name used to organize the objects that you store
     *         in your S3 buckets. For example, object key names that start with the <code>engineering/</code> prefix or
     *         object key names that start with the <code>marketing/campaigns/</code> prefix.
     */
    ...
    public GetAccessGrantsLocationResult withLocationScope(String locationScope) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAccessGrantsLocationResult == false)
            return false;
        GetAccessGrantsLocationResult other = (GetAccessGrantsLocationResult) obj;
