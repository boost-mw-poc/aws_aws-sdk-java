...
public class GetAccessGrantsLocationRequest extends com.amazonaws.AmazonWebServiceRequest implements Serializable, Cloneable {
     ...
     * </p>
     * 
     * @return The ID of the registered location that you are retrieving. S3 Access Grants assigns this ID when you
     *         register the location. S3 Access Grants assigns the ID <code>default</code> to the default location
     *         <code>s3://</code> and assigns an auto-generated ID to other locations that you register.
     */
    ...
    public GetAccessGrantsLocationRequest withAccessGrantsLocationId(String accessGrantsLocationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetAccessGrantsLocationRequest == false)
            return false;
        GetAccessGrantsLocationRequest other = (GetAccessGrantsLocationRequest) obj;
    ...
    public GetAccessGrantsLocationRequest clone() {
        return (GetAccessGrantsLocationRequest) super.clone();
    }
