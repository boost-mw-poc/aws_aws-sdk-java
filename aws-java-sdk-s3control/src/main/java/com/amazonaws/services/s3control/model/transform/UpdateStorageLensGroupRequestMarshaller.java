...
/**
 * UpdateStorageLensGroupRequest Marshaller
 */

@Generated("com.amazonaws:aws-java-sdk-code-generator")
public class UpdateStorageLensGroupRequestMarshaller implements Marshaller<Request<UpdateStorageLensGroupRequest>, UpdateStorageLensGroupRequest> {

    public Request<UpdateStorageLensGroupRequest> marshall(UpdateStorageLensGroupRequest updateStorageLensGroupRequest) {

        if (updateStorageLensGroupRequest == null) {
            throw new SdkClientException("Invalid argument passed to marshall(...)");
        }

        Request<UpdateStorageLensGroupRequest> request = new DefaultRequest<UpdateStorageLensGroupRequest>(updateStorageLensGroupRequest, "AWSS3Control");

        request.setHttpMethod(HttpMethodName.PUT);

        if (updateStorageLensGroupRequest.getAccountId() != null) {
            request.addHeader("x-amz-account-id", StringUtils.fromString(updateStorageLensGroupRequest.getAccountId()));
        }

        String uriResourcePath = "/v20180820/storagelensgroup/{name}";

        uriResourcePath = com.amazonaws.transform.PathMarshallers.NON_GREEDY.marshall(uriResourcePath, "name", updateStorageLensGroupRequest.getName());
        ...
        try {
            ...
            xmlWriter.startElement("UpdateStorageLensGroupRequest");
            if (updateStorageLensGroupRequest != null) {

                {
                    StorageLensGroup storageLensGroup = updateStorageLensGroupRequest.getStorageLensGroup();
